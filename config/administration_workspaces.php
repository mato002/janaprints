            ...
            'groups' => [
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'User Sessions', 'description' => 'Active sessions and sign-in activity.', 'route' => 'admin.security.sessions.index', 'permission' => 'security.sessions.view', 'icon' => 'clock', 'active_routes' => ['admin.security.sessions.*']],
                        ['label' => 'Access Audit', 'description' => 'Authentication and authorization audit trail.', 'route' => 'admin.security.audit.index', 'permission' => 'security.audit.view', 'icon' => 'document-text', 'active_routes' => ['admin.security.audit.*']],
                    ],
                ],
            ],
        ],
            ...
            'groups' => [
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'Master Data', 'description' => 'Shared reference data and lookup values.', 'route' => 'admin.master-data.index', 'permission' => 'configuration.master_data.view', 'icon' => 'template', 'active_routes' => ['admin.master-data.*']],
                        ['label' => 'Document Types', 'description' => 'Document classification and numbering profiles.', 'route' => 'admin.settings.document-types.index', 'permission' => 'configuration.document_types.view', 'icon' => 'document-text', 'active_routes' => ['admin.settings.document-types.*']],
                    ],
                ],
            ],
        ],
            ...
            'groups' => [
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'Approval Chains', 'description' => 'Multi-step approval sequences and sign-off paths.', 'route' => 'admin.governance.chains.index', 'permission' => 'governance.chains.view', 'icon' => 'switch-horizontal', 'active_routes' => ['admin.governance.chains.*']],
                        ['label' => 'Workflow Rules', 'description' => 'Automated business process triggers and actions.', 'route' => 'admin.governance.workflow-rules.index', 'permission' => 'governance.workflow.view', 'icon' => 'cog', 'active_routes' => ['admin.governance.workflow-rules.*']],
                        ['label' => 'Escalations', 'description' => 'Timeout rules and escalation routing.', 'route' => 'admin.governance.escalations.index', 'permission' => 'governance.escalations.view', 'icon' => 'exclamation', 'active_routes' => ['admin.governance.escalations.*']],
                        ['label' => 'Delegations', 'description' => 'Temporary approval authority and substitutes.', 'route' => 'admin.governance.delegations.index', 'permission' => 'governance.delegations.view', 'icon' => 'users', 'active_routes' => ['admin.governance.delegations.*']],
                    ],
                ],
            ],
        ],
