...
return [
    ...
    'featured' => [
        ...
        [
            'name' => 'David O.',
            'organization' => 'Events Company',
            'location' => 'Nairobi',
            'project_type' => 'Event Banners',
            'quote' => 'Our roll-up banners and event signage were produced on time with crisp colour and professional finishing.',
            'photo' => $i['banner'],
