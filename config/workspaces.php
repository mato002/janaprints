        ...
        'groups' => [
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Email', 'description' => 'Compose and track customer email.', 'route' => 'admin.communications.email.dashboard', 'permission' => 'communications.email.view', 'icon' => 'mail', 'active_routes' => ['admin.communications.email.*']],
