...
return [
    ...
    'sections' => [
        ...
        'sales' => [
            ...
            'icon' => 'document-text',
            'quick_actions' => [
                ['label' => 'Open Sales Desk', 'route' => 'admin.sales.desk', 'route_params' => ['from' => 'commercial'], 'permission' => 'quotations.view|artwork.view|sales_orders.view|commercial.approvals.view|crm.customers.create|sales_orders.create'],
