...
return [
    ...
    'sections' => [
        ...
        'payroll' => [
            'title' => 'Payroll',
            'description' => 'Pay runs, salaries, and pay setup.',
            'icon' => 'cash',
            'groups' => [[
                'label' => 'Payroll',
                'items' => [
                    [
                        ...
                        'permission' => 'hr.payroll.view',
                        'icon' => 'cash',
                        'active_routes' => ['admin.hr.payroll.dashboard', 'admin.hr.payroll.index', 'admin.hr.payroll.create', 'admin.hr.payroll.show'],
                    ],
                    [
                        'key' => 'compensation',
                        'label' => 'Overview',
                        'description' => 'Salary coverage and employees missing pay.',
                        'route' => 'admin.hr.compensation.dashboard',
                        'permission' => 'hr.compensation.view',
                        'icon' => 'chart-pie',
                        'active_routes' => ['admin.hr.compensation.dashboard'],
                    ],
                    [
                        ...
                        'permission' => 'hr.compensation.view',
                        'icon' => 'table-cells',
                        'active_routes' => ['admin.hr.compensation.register', 'admin.hr.compensation.edit', 'admin.hr.compensation.create'],
                    ],
                    [
                        'key' => 'payroll-classes',
                        'label' => 'Classes',
                        'description' => 'Salary bands for onboarding.',
                        'route' => 'admin.hr.compensation.templates',
                        'permission' => 'hr.compensation.view',
                        'icon' => 'collection',
                        'active_routes' => ['admin.hr.compensation.templates', 'admin.hr.compensation.templates.*'],
                    ],
                    [
                        'key' => 'payroll-groups',
                        'label' => 'Pay groups',
                        'description' => 'Payroll run groups such as Main or Casual.',
                        'route' => 'admin.hr.compensation.payroll-groups',
                        'permission' => 'hr.compensation.view',
                        'icon' => 'users',
                        'active_routes' => ['admin.hr.compensation.payroll-groups', 'admin.hr.compensation.payroll-groups.*'],
                    ],
                    [
                        'key' => 'allowances',
                        'label' => 'Allowances',
                        'description' => 'Reusable allowance types.',
                        'route' => 'admin.hr.compensation.allowances',
                        'permission' => 'hr.compensation.view',
                        'icon' => 'plus-circle',
                        'active_routes' => ['admin.hr.compensation.allowances', 'admin.hr.compensation.allowances.*'],
                    ],
                    [
                        'key' => 'deductions',
                        'label' => 'Deductions',
                        'description' => 'Statutory and custom deductions.',
                        'route' => 'admin.hr.compensation.deductions',
                        'permission' => 'hr.compensation.view',
                        'icon' => 'minus-circle',
                        'active_routes' => ['admin.hr.compensation.deductions', 'admin.hr.compensation.deductions.*'],
                    ],
                ],
            ]],
        ],
