...
return [
    'hub' => [
        ...
        [
            'label' => 'Sales',
            'description' => 'Sales reports and customer intelligence.',
            'route' => 'admin.workspaces.reports.section',
    ...
    'sections' => [
        ...
        'commercial' => [
            'title' => 'Sales',
            'description' => 'Sales reports and intelligence.',
            'icon' => 'shopping-cart',
            'presentation' => 'hub',
            ...
            'groups' => [[
                'label' => 'Sales',
                'items' => [
                    ['key' => 'commercial-reports', 'label' => 'Sales Reports', 'description' => 'Sales, pipeline, customer, artwork, and exports.', 'route' => 'admin.reports.commercial', 'permission' => 'reports.view|commercial.reports.sales.view', 'icon' => 'document-text', 'active_routes' => ['admin.reports.commercial', 'admin.commercial.reports.*']],
                    ['key' => 'commercial-360', 'label' => 'Sales 360', 'description' => 'Sales and customer management intelligence.', 'route' => 'admin.reports.commercial360', 'permission' => 'intelligence.commercial.view|reports.view', 'icon' => 'document-text', 'active_routes' => ['admin.reports.commercial360']],
                    ['key' => 'commercial-intelligence', 'label' => 'Sales Intelligence', 'description' => 'Job, customer, product profitability, waste, and outsource analysis.', 'route' => 'admin.reports.commercial-intelligence', 'permission' => 'intelligence.commercial.view|reports.view', 'icon' => 'chart-bar', 'active_routes' => ['admin.reports.commercial-intelligence']],
