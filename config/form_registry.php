    ...
    'forms' => [
        ...
        'inventory_item' => [
            ...
            'fields' => [
                ...
                'press_process' => ['label' => 'Process', 'type' => 'select', 'required' => false, 'visible' => true, 'sort_order' => 5],
                'description' => ['label' => 'Description', 'type' => 'textarea', 'required' => false, 'visible' => true, 'sort_order' => 6],
                'reorder_level' => ['label' => 'Reorder level', 'type' => 'number', 'required' => true, 'visible' => true, 'sort_order' => 7, 'default' => 0],
                'reorder_quantity' => ['label' => 'Reorder qty', 'type' => 'number', 'required' => true, 'visible' => true, 'sort_order' => 8, 'default' => 0],
                'standard_cost' => ['label' => 'Standard cost', 'type' => 'number', 'required' => true, 'visible' => true, 'sort_order' => 9, 'default' => 0],
            ],
        ],
