...
enum ProductionJobCardStatus: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::Completed => __('Awaiting finished goods'),
    ...
    public function allowedTransitions(): array
    {
        return match ($this) {
            ...
            self::InProduction => [self::Completed, self::QualityCheck, self::Outsourced, self::Cancelled, self::OnHold],
            self::Outsourced => [self::Returned, self::Cancelled, self::OnHold],
            self::Returned => [self::InProduction, self::QualityCheck, self::OnHold],
            self::QualityCheck => [self::Completed, self::Rework, self::AwaitingCustomerApproval, self::OnHold],
            self::AwaitingCustomerApproval => [self::Completed, self::Rework, self::OnHold],
