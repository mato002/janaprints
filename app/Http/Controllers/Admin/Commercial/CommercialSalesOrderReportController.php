...
use App\Support\Commercial\Reports\CommercialSalesOrderReportPresenter;
...
class CommercialSalesOrderReportController extends Controller
{
    public function __construct(
        protected CommercialSalesOrderReportPresenter $presenter,
    ...
    {
        abort_unless($request->user()?->can('commercial.reports.sales_orders.view'), 403);
    ...
    public function export(Request $request): RedirectResponse
    {
        ...
        return $this->exportService->queue(
            ...
            format: $format,
            redirectRoute: 'commercial.reports.sales_orders.index',
        );
    }
     ...
     */
    protected function serializeScope(CommercialSalesOrderReportScope $scope): array
    {
        return [
