...
class QuotationDocumentPresenter
{
    ...
    public function present(Quotation $quotation): array
    {
        ...
        return [
            ...
            'meta' => $this->filterMetaRows([
                ['label' => __('Prepared by'), 'value' => $quotation->preparer?->name],
                ['label' => __('Revision'), 'value' => $quotation->revision_number ? 'Rev '.$quotation->revision_number : null],
                ['label' => __('Artwork reference'), 'value' => $this->resolveArtworkReference($quotation, $custom)],
                ['label' => __('Delivery timeline'), 'value' => $custom['delivery_timeline'] ?? null],
                ['label' => __('Delivery method'), 'value' => $custom['delivery_method'] ?? null],
                ['label' => __('Production notes'), 'value' => $custom['production_notes'] ?? null],
            ]),
            'columns' => [
                ['key' => 'index', 'label' => __('No'), 'align' => 'left', 'width' => '5%'],
                ['key' => 'description', 'label' => __('Item & Description'), 'align' => 'left', 'width' => '40%'],
                ['key' => 'quantity', 'label' => __('Qty'), 'align' => 'right', 'width' => '10%'],
                ['key' => 'unit', 'label' => __('Unit'), 'align' => 'left', 'width' => '10%'],
                ['key' => 'rate', 'label' => __('Rate'), 'align' => 'right', 'width' => '15%'],
