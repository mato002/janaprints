...
use App\Support\Assets\AssetWorkspaceCountService;
use Illuminate\Support\Facades\Route;

class AssetsWorkspacePresenter
{
    public function __construct(
        protected ?WorkspaceNavigationResolver $navigation = null,
        protected ?AssetWorkspaceCountService $counts = null,
    ) {
        $this->navigation ??= app(WorkspaceNavigationResolver::class);
        $this->counts ??= app(AssetWorkspaceCountService::class);
    }
    ...
    {
        return config('assets_workspaces.groups', []);
    }
    ...
    {
        $routes = ['admin.workspaces.assets'];
