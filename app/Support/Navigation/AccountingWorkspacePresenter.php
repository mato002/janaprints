...
class AccountingWorkspacePresenter
{
    ...
    {
        return config('accounting_workspaces.hub', []);
    }
    ...
    {
        return config('accounting_workspaces.sections', []);
    }
    ...
    public function presentHub(): ?array
    {
        ...
        return [
            'title' => __('Accounting'),
            'description' => __('General ledger, receivables, payables, tax, and financial reporting.'),
    ...
    public function collectActiveRoutes(): array
    {
        ...
        foreach ($this->sectionDefinitions() as $section => $definition) {
            $routes[] = "admin.workspaces.accounting.section:{$section}";
