...
class SupplierPerformanceScopeResolver
{
    public function __construct(
        protected SupplierPerformanceReadiness $readiness,
    ) {}

    /**
     * @return array{
     *     scope: SupplierPerformanceScope,
    ...
    public function resolve(Request $request): array
    {
        ...
        $scope = new SupplierPerformanceScope(
            ...
            tab: (string) $request->input('tab', 'scorecard'),
        ...
        return [
            ...
            'suppliers' => $suppliers,
            'can_export' => $user?->can('procurement.performance.export') ?? false,
            'filters' => [
