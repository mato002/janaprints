...
class InventoryReportScopeResolver
{
    public function __construct(
        protected InventoryReportReadiness $readiness,
    ) {}
     ...
     *     items: Collection<int, InventoryItem>,
     *     can_export: bool,
    ...
    public function resolve(Request $request): array
    {
        ...
        $scope = new InventoryReportScope(
            ...
            branchId: $branchId,
            fromDate: (string) $request->input('from_date', now()->subDays(90)->toDateString()),
            ...
            tab: (string) $request->input('tab', 'stock_on_hand'),
        ...
        return [
            ...
            'suppliers' => $suppliers,
            'items' => $items,
            'can_export' => $user?->can('reports.inventory.export') ?? false,
            'filters' => [
