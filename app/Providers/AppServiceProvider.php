...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function policies(): array
    {
        ...
        \App\Models\Hr\LeaveType::class => \App\Policies\LeaveConfigurationPolicy::class,
        \App\Models\Hr\Vacancy::class => \App\Policies\RecruitmentPolicy::class,
        \App\Models\Hr\JobRequisition::class => \App\Policies\RecruitmentPolicy::class,
        \App\Models\Hr\JobApplication::class => \App\Policies\RecruitmentPolicy::class,
        \App\Models\Hr\OfferLetter::class => \App\Policies\RecruitmentPolicy::class,
        \App\Models\Hr\OnboardingRecord::class => \App\Policies\RecruitmentPolicy::class,
        ...
        \App\Models\PrintingIntelligence\PrintAdvisorRecommendation::class => \App\Policies\PrintingIntelligence\PrintAdvisorRecommendationPolicy::class,
        ProductionQueue::class => ProductionQueuePolicy::class,
        \App\Models\Production\ProductBom::class => \App\Policies\ProductBomPolicy::class,
        \App\Models\Production\ProductionOutput::class => \App\Policies\ProductionOutputPolicy::class,
