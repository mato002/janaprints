...
class MachineIntelligenceWorkspaceTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_workspace_loads_with_kpi_cards(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->get(route('admin.printing-intelligence.machines'))
            ->assertOk()
            ->assertSee(__('Machine Intelligence'))
            ->assertSee(__('Most Profitable Machine'));
    }
