...
class Branch360Test extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_branch_360_comparison_loads(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertOk()
            ->assertSee(__('Branch 360'), false)
            ->assertSee(__('Branch Comparison'), false);
    }

    public function test_specific_branch_filter(): void
    {
        [$company, $branch, $user] = $this->tenantUser(['reports.view']);
        ...
        $this->actingAs($user)
            ->get(route('admin.reports.branch360', ['branch_id' => $branch->id]))
            ->assertOk();
    }
