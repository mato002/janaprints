...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($action),'max-width' => 'md']); ?>
    <div class="space-y-4">
        <div>
            <label class="erp-label" for="payroll-group-name"><?php echo e(__('Name')); ?></label>
            <input type="text" id="payroll-group-name" name="name" class="erp-input w-full" value="<?php echo e(old('name')); ?>" required>
        </div>
        <div>
            <label class="erp-label" for="payroll-group-code"><?php echo e(__('Code')); ?></label>
            <input type="text" id="payroll-group-code" name="code" class="erp-input w-full" value="<?php echo e(old('code')); ?>" maxlength="30">
            <p class="mt-1 text-xs text-slate-500"><?php echo e(__('Optional. Auto-generated from the name if left blank.')); ?></p>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\lookups\quick-create\payroll-group.blade.php ENDPATH**/ ?>