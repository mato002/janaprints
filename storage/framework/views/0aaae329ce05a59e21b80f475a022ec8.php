...
<head>
    ...
    <title><?php echo e($subject ?? ($companyName ?? 'Jana Prints')); ?></title>
</head>
                ...
                <tr>
                    <td style="background:linear-gradient(135deg,#0f1b3d 0%,#1a2744 100%);border-radius:12px 12px 0 0;padding:28px 32px;text-align:center;">
                        <?php if(! empty($logoDataUri)): ?>
                            <img src="<?php echo e($logoDataUri); ?>" alt="<?php echo e($companyName ?? 'Jana Prints'); ?>" style="max-height:64px;max-width:220px;height:auto;width:auto;margin:0 auto 12px;display:block;">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:0.5px;"><?php echo e($companyName ?? 'Jana Prints'); ?></h1>
                ...
                <tr>
                    <td style="background:#0f1b3d;border-radius:0 0 12px 12px;padding:20px 32px;text-align:center;">
                        <p style="margin:0;color:rgba(255,255,255,0.7);font-size:12px;line-height:1.6;">
                            &copy; <?php echo e(date('Y')); ?> <?php echo e($companyName ?? 'Jana Prints'); ?>. All rights reserved.<br>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\mail\layouts\jana.blade.php ENDPATH**/ ?>