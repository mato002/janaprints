...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
        <h3 class="mb-3 font-semibold text-erp-primary"><?php echo e($label); ?></h3>
...
<?php $component->withAttributes([]); ?>
             <?php $__env->slot('head', null, []); ?> <tr><th><?php echo e(__('Title')); ?></th><th><?php echo e(__('Category')); ?></th><th><?php echo e(__('Expiry')); ?></th></tr> <?php $__env->endSlot(); ?>
             <?php $__env->slot('body', null, []); ?> 
                <?php $__empty_1 = true; $__currentLoopData = $documents[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><a href="<?php echo e(route('admin.hr.documents.show', $doc)); ?>" class="text-erp-primary hover:underline"><?php echo e($doc->title); ?></a></td>
                        <td><?php echo e($doc->category?->label() ?? $doc->category); ?></td>
                        <td><?php echo e($doc->expires_at?->format('M j, Y') ?? '—'); ?></td>
                    </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['title' => __('None on file')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('None on file'))]); ?>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\employees\360\tabs\documents.blade.php ENDPATH**/ ?>