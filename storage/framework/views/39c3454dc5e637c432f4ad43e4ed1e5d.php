...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('POS sales'),'breadcrumbs' => [['label' => __('Commercial'), 'url' => route('admin.workspaces.commercial')], ['label' => __('POS Desk'), 'url' => route('admin.commercial.pos.counter-sales')], ['label' => __('Daily sales')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <?php echo $__env->make('admin.commercial.pos.partials.desk-mode-nav', ['activePosView' => 'sales'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
