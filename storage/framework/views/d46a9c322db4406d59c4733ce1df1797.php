...
<?php $component->withAttributes(['class' => 'mb-4','id' => 'log-activity']); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Crm\CustomerActivity::class)): ?>
        <form method="POST" action="<?php echo e(route('admin.crm.customers.activities.store', $customer)); ?>" class="grid grid-cols-1 gap-3 md:grid-cols-2" data-turbo-frame="_top">
            <?php echo csrf_field(); ?>
            <div>
