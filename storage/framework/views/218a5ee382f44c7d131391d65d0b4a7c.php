...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal-form','data' => ['title' => __('New artwork request'),'breadcrumbs' => [['label' => __('Artwork'), 'url' => route('admin.artwork.dashboard')], ['label' => __('New')]],'maxWidth' => '2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('New artwork request')),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => __('Artwork'), 'url' => route('admin.artwork.dashboard')], ['label' => __('New')]]),'maxWidth' => '2xl']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-shell','data' => ['action' => route('admin.artwork.store'),'class' => 'space-y-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.artwork.store')),'class' => 'space-y-4']); ?>
        <?php if($fromSalesDesk ?? false): ?>
            <input type="hidden" name="from" value="sales-desk">
        <?php endif; ?>
        <?php echo $__env->make('admin.artwork.requests.partials.form', [
...
<?php $component->withAttributes([]); ?>
            <button type="submit" class="erp-btn-primary"><?php echo e(__('Create request')); ?></button>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\artwork\requests\create.blade.php ENDPATH**/ ?>