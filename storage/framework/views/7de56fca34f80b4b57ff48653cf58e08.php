...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
    <h3 class="mb-3 font-semibold text-erp-primary"><?php echo e(__('Attendance Register')); ?> (<?php echo e(now()->format('F Y')); ?>)</h3>
...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('head', null, []); ?> 
            <tr><th><?php echo e(__('Date')); ?></th><th><?php echo e(__('Status')); ?></th><th><?php echo e(__('Late (min)')); ?></th><th><?php echo e(__('Overtime')); ?></th></tr>
         <?php $__env->endSlot(); ?>
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $attendance['records']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><?php echo e($record->attendance_date?->format('M j, Y')); ?></td>
                    <td><?php echo e(ucfirst($record->status?->value ?? '')); ?></td>
                    <td><?php echo e($record->late_minutes); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['title' => __('No attendance records this month')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No attendance records this month'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-pagination','data' => ['paginator' => $attendance['records']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attendance['records'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <h3 class="mb-3 font-semibold text-erp-primary"><?php echo e(__('Leave Calendar Overlay')); ?></h3>
    <p class="text-sm text-slate-600"><?php echo e(__('Days with approved leave highlighted in register context.')); ?></p>
    <div class="mt-3 grid grid-cols-7 gap-1 text-center text-xs">
        <?php $__currentLoopData = $attendance['calendar_month']->take(31); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="rounded p-1 <?php echo e($day['requests']->isNotEmpty() ? 'bg-amber-100 text-amber-900' : 'bg-slate-50'); ?>">
                <?php echo e(\Illuminate\Support\Carbon::parse($day['date'])->format('j')); ?>
...
<?php unset($__componentOriginalad5130b5347ab6ecc017d2f5a278b926); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/hr/employees/360/tabs/attendance.blade.php ENDPATH**/ ?>