...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal-form','data' => ['title' => __('Email employees'),'breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Email employees')),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => __('HR'), 'url' => route('admin.workspaces.hr')],
        ['label' => __('Employees'), 'url' => route('admin.employees.index')],
        ['label' => __('Email')],
    ]),'maxWidth' => '3xl']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-shell','data' => ['action' => url()->route('admin.employees.email.send')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url()->route('admin.employees.email.send'))]); ?>
        <?php if($allActive): ?>
        ...
        <?php else: ?>
            <?php $__currentLoopData = $recipients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <input type="hidden" name="employees[]" value="<?php echo e($recipient->id); ?>">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>

        <p class="mb-4 text-sm text-slate-500">
            <?php echo e(__('Send a message from the HR mailbox to selected staff. Each employee receives their own email.')); ?>

        </p>

        <div class="mb-4 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
            <p class="text-sm font-medium text-slate-700">
                <?php echo e(trans_choice(':count recipient|:count recipients', $recipients->count(), ['count' => $recipients->count()])); ?>

                <?php if($allActive): ?>
                    <span class="text-slate-500">(<?php echo e(__('all active staff with email')); ?>)</span>
                <?php endif; ?>
            </p>
            <ul class="mt-2 max-h-40 space-y-1 overflow-y-auto text-sm text-slate-600">
                <?php $__currentLoopData = $recipients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><?php echo e($recipient->full_name); ?> &lt;<?php echo e($recipient->email); ?>&gt;</li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
        ...
        <div class="space-y-4">
            <div>
                <label class="erp-label" for="email_subject"><?php echo e(__('Subject')); ?></label>
                <input id="email_subject" type="text" name="subject" class="erp-input w-full" value="<?php echo e(old('subject', $subject)); ?>" required maxlength="255">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="erp-label" for="email_body"><?php echo e(__('Message')); ?></label>
                <textarea id="email_body" name="body" rows="10" class="erp-input w-full" required><?php echo e(old('body', $body)); ?></textarea>
                <p class="mt-1 text-xs text-slate-500">
                    <?php echo e(__('Optional placeholders')); ?>: {{ name }}, {{ employee_number }}
                </p>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('Send emails')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\employees\email\compose.blade.php ENDPATH**/ ?>