...
<div <?php echo e($attributes->merge(['class' => 'compact-workspace-header'])); ?>>
    <div class="compact-workspace-header__row">
        <div class="compact-workspace-header__title-group min-w-0">
            ...
            <?php if($description): ?>
                <p class="compact-workspace-header__description truncate"><?php echo e($description); ?></p>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\Users\HP\Desktop\Newfolder\janaprints\resources\views/components/admin/compact-workspace-header.blade.php ENDPATH**/ ?>