...
<?php
    $indexRoute = $index_route ?? 'admin.commercial.reports.artwork.index';
?>
...
<nav class="mb-4 flex gap-1 overflow-x-auto rounded-xl border border-slate-200 bg-white p-1 shadow-sm" aria-label="<?php echo e(__('Artwork report tabs')); ?>">
    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a
            href="<?php echo e(\App\Support\Navigation\WorkspaceEmbed::url(route($indexRoute, array_merge($filters, ['tab' => $tab['key'], 'page' => 1])))); ?>"
