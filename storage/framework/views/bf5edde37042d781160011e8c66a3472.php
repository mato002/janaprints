...
<?php $component->withAttributes(['class' => 'mb-6 !p-2']); ?>
    <nav class="flex flex-wrap gap-1" role="tablist" aria-label="<?php echo e(__('Inventory report tabs')); ?>">
        <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $query = array_merge($filters, ['tab' => $tab['key'], 'page' => 1]);
            ?>
            <a
                href="<?php echo e(WorkspaceEmbed::url(route('admin.inventory.reports.index', $query))); ?>"
                role="tab"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/inventory/reports/partials/tabs.blade.php ENDPATH**/ ?>