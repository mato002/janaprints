            ...
            <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-center gap-1.5" aria-current="<?php echo e(empty($crumb['url']) ? 'page' : false); ?>">
                    ...
                    <?php if(! empty($crumb['url'])): ?>
                        ...
                        <a href="<?php echo e(WorkspaceEmbed::mainUrl($crumb['url']) ?? $crumb['url']); ?>" data-turbo-frame="erp-main" data-turbo-action="advance" class="transition-colors hover:text-erp-accent"><?php echo e($crumb['label']); ?></a>
                    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Desktop\Newfolder\janaprints\resources\views/admin/partials/breadcrumbs.blade.php ENDPATH**/ ?>