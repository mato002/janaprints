...
<?php $component->withAttributes(['searchable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'exportable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
     <?php $__env->slot('head', null, []); ?> 
        <tr>
            ...
            <th scope="col" class="hidden lg:table-cell"><?php echo e(__('Work Center')); ?></th>
            <th scope="col"><?php echo e(__('Status')); ?></th>
            <th scope="col" class="hidden md:table-cell"><?php echo e(__('Priority')); ?></th>
            <th scope="col" class="hidden sm:table-cell"><?php echo e(__('Planned Start')); ?></th>
            <th scope="col" class="hidden sm:table-cell"><?php echo e(__('Planned End')); ?></th>
            <th scope="col" class="hidden md:table-cell"><?php echo e(__('Due Date')); ?></th>
     ...
     <?php $__env->slot('body', null, []); ?> 
        <?php $__empty_1 = true; $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <tr class="<?php echo e($isOverdue ? 'bg-red-50/40' : ($missingSchedule ? 'bg-amber-50/30' : '')); ?>">
                <td class="font-mono text-sm font-medium"><?php echo e($job->job_card_number); ?></td>
                <td><?php echo e($job->customer?->company_name ?? '—'); ?></td>
                <td class="hidden lg:table-cell"><?php echo e($centers !== [] ? implode(', ', $centers) : '—'); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.enum-status-badge','data' => ['status' => $job->status->value]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($job->status->value)]); ?>
...
<?php endif; ?></td>
                <td class="hidden md:table-cell capitalize"><?php echo e(str_replace('_', ' ', $job->priority->value)); ?></td>
                <td class="hidden sm:table-cell tabular-nums"><?php echo e($job->planned_start_date?->format('M j, Y') ?? '—'); ?></td>
                <td class="hidden sm:table-cell tabular-nums"><?php echo e($job->planned_end_date?->format('M j, Y') ?? '—'); ?></td>
                <td class="hidden md:table-cell tabular-nums <?php echo e($isOverdue ? 'text-red-700 font-medium' : ''); ?>">
...
<?php endif; ?>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('schedule', $job)): ?>
                            <?php if(Route::has('admin.production.job-cards.show')): ?>
                                <?php if (isset($component)) { $__componentOriginalba3edbcdd111d8ddf5ca96c9a176d3d0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalba3edbcdd111d8ddf5ca96c9a176d3d0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.production.job-cards.show', $job)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $job)): ?>
                            <?php if(Route::has('admin.production.job-cards.edit')): ?>
                                <?php if (isset($component)) { $__componentOriginalba3edbcdd111d8ddf5ca96c9a176d3d0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalba3edbcdd111d8ddf5ca96c9a176d3d0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.production.job-cards.edit', $job)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.table-row-action'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.production.job-cards.edit', $job))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'calendar','title' => __('No jobs match your filters'),'description' => __('Set planned dates on job cards to appear in scheduling, or clear filters to see all schedulable jobs.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'calendar','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No jobs match your filters')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Set planned dates on job cards to appear in scheduling, or clear filters to see all schedulable jobs.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-pagination','data' => ['paginator' => $jobs]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/production/scheduling/partials/list.blade.php ENDPATH**/ ?>