...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('body', null, []); ?> 
        <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td class="font-mono text-xs"><?php echo e($application->reference); ?></td>
                <td>
                ...
                <td><span class="erp-badge bg-slate-100 text-slate-700"><?php echo e($application->stage->label()); ?></span></td>
                <td><?php echo e($application->applied_at->format('Y-m-d')); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <tr><td colspan="5" class="py-6 text-center text-slate-500"><?php echo e(__('No applications found.')); ?></td></tr>
        <?php endif; ?>
     <?php $__env->endSlot(); ?>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/hr/recruitment/partials/workspace-applications.blade.php ENDPATH**/ ?>