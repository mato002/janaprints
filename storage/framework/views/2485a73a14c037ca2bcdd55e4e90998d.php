...
<?php endif; ?>
            ...
            <p class="mt-1 text-xs text-gray-500">
                ...
                <a href="<?php echo e(route('admin.hr.compensation.templates')); ?>" class="text-erp-accent hover:underline" data-turbo-frame="erp-main" data-turbo-action="advance"><?php echo e(__('Manage payroll classes')); ?></a>
            </p>
        </div>
