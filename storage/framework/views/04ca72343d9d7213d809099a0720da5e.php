...
<?php if($resolvedHref): ?>
    <a href="<?php echo e($resolvedHref); ?>" data-turbo-frame="<?php echo e($turboFrame); ?>" data-turbo-action="advance" <?php echo e($attributes->merge(['class' => 'exec-hero-metric exec-hero-metric--link'])); ?>>
<?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Desktop\Newfolder\janaprints\resources\views/components/admin/exec-hero-metric.blade.php ENDPATH**/ ?>