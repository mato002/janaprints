...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Inventory'),'breadcrumbs' => [['label' => __('Supply Chain'), 'url' => route('admin.workspaces.supply-chain')], ['label' => __('Inventory')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Inventory & Store')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Inventory & Store'))]); ?>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        <?php $__currentLoopData = [
            ...
            <?php if(! empty($card['route'])): ?>
                <a href="<?php echo e(route($card['route'])); ?>" class="block">
...
<?php $component->withAttributes(['class' => 'mt-6 flex flex-wrap gap-2']); ?>
        <a href="<?php echo e(route('admin.inventory.store.dashboard')); ?>" class="erp-btn-secondary"><?php echo e(__('Store dashboard')); ?></a>
        <a href="<?php echo e(route('admin.inventory.store.balances')); ?>" class="erp-btn-secondary"><?php echo e(__('Store balances')); ?></a>
        <a href="<?php echo e(route('admin.inventory.warehouses.index')); ?>" class="erp-btn-secondary"><?php echo e(__('Warehouses')); ?></a>
        ...
        <?php if(auth()->user()?->can('inventory.transfer')): ?>
            <a href="<?php echo e(route('admin.inventory.transfers.create')); ?>" class="erp-btn-secondary" data-erp-modal-open><?php echo e(__('Transfer stock')); ?></a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Inventory\StockReceipt::class)): ?>
            <a href="<?php echo e(route('admin.inventory.receipts.create')); ?>" class="erp-btn-secondary"><?php echo e(__('Stock receipt')); ?></a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Inventory\StockIssue::class)): ?>
            <a href="<?php echo e(route('admin.inventory.issues.create')); ?>" class="erp-btn-secondary"><?php echo e(__('Stock issue')); ?></a>
        <?php endif; ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\inventory\dashboard.blade.php ENDPATH**/ ?>