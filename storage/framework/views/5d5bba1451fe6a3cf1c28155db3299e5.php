<div class="<?php if($embeddedInFloor ?? false): ?> space-y-3 <?php endif; ?>">
    <?php if($embeddedInFloor ?? false): ?>
        <div>
            <h2 class="text-sm font-semibold text-erp-primary"><?php echo e(__('Finished goods outputs')); ?></h2>
            <p class="text-xs text-slate-600"><?php echo e(__('Completion records posted from production jobs.')); ?></p>
        </div>
    <?php endif; ?>
...
<?php $component->withAttributes([]); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $outputs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $output): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td>
                        <?php if($output->jobCard): ?>
                            <a href="<?php echo e(route('admin.production.job-cards.show', ['jobCard' => $output->jobCard, 'tab' => 'outputs'])); ?>" class="erp-link"><?php echo e($output->jobCard->job_card_number); ?></a>
                        <?php else: ?>
                            —
                        <?php endif; ?>
                    </td>
                    ...
                    <td><?php echo e($output->completion_status->label()); ?></td>
                    <td><?php echo e($output->completed_at?->format('Y-m-d H:i') ?? '—'); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'cube','title' => __('No outputs yet')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'cube','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No outputs yet'))]); ?>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/production/outputs/partials/register-content.blade.php ENDPATH**/ ?>