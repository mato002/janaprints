...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Maintenance Calendar'),'breadcrumbs' => [['label' => __('Assets'), 'url' => route('admin.workspaces.assets')], ['label' => __('Maintenance Calendar')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Maintenance Calendar'),'description' => $calendar['period_label']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Maintenance Calendar')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($calendar['period_label'])]); ?>
...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
        <div class="flex flex-wrap gap-2">
            <?php $__currentLoopData = ['month' => __('Month'), 'week' => __('Week'), 'upcoming' => __('Upcoming'), 'overdue' => __('Overdue')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('admin.assets.maintenance.calendar', ['view' => $view])); ?>" class="<?php echo e($activeView === $view ? 'erp-btn-primary' : 'erp-btn-secondary'); ?>"><?php echo e($label); ?></a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\maintenance\calendar.blade.php ENDPATH**/ ?>