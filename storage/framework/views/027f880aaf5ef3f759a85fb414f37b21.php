...
<?php if($inDrawer): ?>
    <turbo-frame id="erp-preview-drawer">
        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['erp-drawer', $drawerMaxWidth]); ?>" data-erp-drawer-panel>
            <div class="erp-drawer__header">
                <h2 class="erp-drawer__title"><?php echo e($title); ?></h2>
                <button
                    type="button"
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\admin\drawer.blade.php ENDPATH**/ ?>