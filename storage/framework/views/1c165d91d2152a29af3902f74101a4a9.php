...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($description)]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php echo $__env->make('admin.commercial.pos.intelligence.partials.export-actions', [
...
<?php endif; ?>
    ...
    <?php echo $__env->make('admin.commercial.pos.intelligence.partials.filters', [
        'filters' => $filters,
        'branches' => $branches,
        'cashiers' => $cashiers,
    ...
    <?php echo $__env->make('admin.commercial.pos.intelligence.partials.kpi-strip', [
        'title' => __('Overview'),
        'kpis' => array_merge($dashboard_kpis, $metrics),
    ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('admin.commercial.pos.intelligence.partials.tab-content', [
        'tab_data' => $tab_data,
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\commercial\pos\intelligence\index.blade.php ENDPATH**/ ?>