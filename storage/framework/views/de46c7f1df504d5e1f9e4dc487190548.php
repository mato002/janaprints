...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => $document['documentNumber'],'breadcrumbs' => [['label' => __('Invoices'), 'url' => route('admin.invoices.index')], ['label' => $invoice->invoice_number, 'url' => route('admin.invoices.show', $invoice)], ['label' => __('Document')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['class' => 'jp-doc-print-hide','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($document['title']),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($document['documentNumber'])]); ?>
        <a href="<?php echo e(route('admin.invoices.show', $invoice)); ?>" class="erp-btn-secondary"><?php echo e(__('Back to invoice')); ?></a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.card','data' => ['class' => 'mx-auto max-w-4xl print:shadow-none print:border-0','id' => 'invoice-document']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mx-auto max-w-4xl print:shadow-none print:border-0','id' => 'invoice-document']); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\documents\invoice\show.blade.php ENDPATH**/ ?>