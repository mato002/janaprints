...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Compensation'),'breadcrumbs' => [['label' => __('HR'), 'url' => route('admin.workspaces.hr')], ['label' => __('Compensation')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Compensation'),'description' => __('Overview of employee pay. Use the tabs above for salaries, payroll classes, and allowance/deduction libraries.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Compensation')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Overview of employee pay. Use the tabs above for salaries, payroll classes, and allowance/deduction libraries.'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Hr\EmployeeCompensation::class)): ?>
                <a href="<?php echo e(route('admin.hr.compensation.create')); ?>" class="erp-btn-primary" data-erp-modal-open><?php echo e(__('Assign salary')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <?php if(($stats['pending_approval'] ?? 0) > 0): ?>
        <div class="mt-4 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
            <?php echo e(trans_choice(':count salary change awaits approval.|:count salary changes await approval.', $stats['pending_approval'], ['count' => $stats['pending_approval']])); ?>

            <a href="<?php echo e(route('admin.hr.compensation.register')); ?>" class="ml-1 font-medium text-erp-accent hover:underline"><?php echo e(__('Review in salary register')); ?></a>
        </div>
    <?php endif; ?>
...
<?php $component->withAttributes(['class' => 'mt-6','padding' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
        <div class="flex items-center justify-between border-b border-erp-border px-4 py-3">
            <div>
                <h2 class="text-sm font-semibold text-erp-primary"><?php echo e(__('Employees without salary')); ?></h2>
                <p class="mt-0.5 text-xs text-slate-500"><?php echo e(__('These employees cannot be included in payroll until a salary is assigned.')); ?></p>
            </div>
            <a href="<?php echo e(route('admin.hr.compensation.register', ['coverage' => 'missing'])); ?>" class="shrink-0 text-sm font-medium text-erp-accent hover:underline"><?php echo e(__('View all')); ?></a>
        </div>
...
<?php $component->withAttributes(['searchable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'exportable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
             <?php $__env->slot('head', null, []); ?> 
                <tr>
                    ...
                    <th class="hidden md:table-cell"><?php echo e(__('Branch')); ?></th>
                    <th class="erp-table-actions-col"><?php echo e(__('Actions')); ?></th>
                </tr>
             <?php $__env->endSlot(); ?>
             <?php $__env->slot('body', null, []); ?> 
                <?php $__empty_1 = true; $__currentLoopData = $missingEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                        ...
                        <td class="hidden md:table-cell"><?php echo e($employee->branch?->name ?? '—'); ?></td>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.compensation.edit', $employee))]); ?><?php echo e(__('Assign salary')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'check-circle','title' => __('All active employees have salaries'),'description' => __('You can revise pay or manage payroll classes from the tabs above.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'check-circle','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('All active employees have salaries')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('You can revise pay or manage payroll classes from the tabs above.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hr.compensation.audit')): ?>
        <p class="mt-4 text-right text-xs text-slate-500">
            <a href="<?php echo e(route('admin.hr.compensation.audit')); ?>" class="text-erp-accent hover:underline"><?php echo e(__('Compensation audit log')); ?></a>
        </p>
    <?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\compensation\dashboard.blade.php ENDPATH**/ ?>