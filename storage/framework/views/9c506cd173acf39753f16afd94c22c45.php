...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Counter Sales'),'breadcrumbs' => [['label' => __('POS'), 'url' => route('admin.commercial.pos.dashboard')], ['label' => __('Counter Sales')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    >
        ...
        <div class="mb-3 flex flex-wrap items-center gap-2">
            ...
            <a href="<?php echo e(route('admin.commercial.pos.dashboard')); ?>" class="erp-btn-secondary text-sm"><?php echo e(__('POS dashboard')); ?></a>
        </div>
