...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal-form','data' => ['title' => __('Record Return'),'breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Record Return')),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => __('Assets'), 'url' => route('admin.workspaces.assets')],
        ['label' => __('Returns'), 'url' => route('admin.assets.custody.returns.index')],
        ['label' => __('Record Return')],
    ]),'maxWidth' => '2xl']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-shell','data' => ['action' => route('admin.assets.custody.returns.store')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.assets.custody.returns.store'))]); ?>
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                <label class="erp-label" for="return_date"><?php echo e(__('Return Date')); ?></label>
                <input type="date" id="return_date" name="return_date" value="<?php echo e(now()->toDateString()); ?>" class="erp-input w-full" required>
            </div>
            <div>
                <label class="erp-label" for="condition"><?php echo e(__('Condition')); ?></label>
...
<?php $component->withAttributes([]); ?>
            <button type="submit" class="erp-btn-primary"><?php echo e(__('Record Return')); ?></button>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\custody\returns\create.blade.php ENDPATH**/ ?>