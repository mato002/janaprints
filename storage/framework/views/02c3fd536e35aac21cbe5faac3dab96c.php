...
<?php endif; ?>
    ...
    <?php if(($fields['source']['visible'] ?? true)): ?>
        <div>
            <label class="erp-label"><?php echo e($fields['source']['label'] ?? __('Source')); ?></label>
            <select name="source" class="erp-input w-full" <?php if($fields['source']['required'] ?? true): echo 'required'; endif; ?> <?php if($fields['source']['read_only'] ?? false): echo 'disabled'; endif; ?>>
                <?php $__currentLoopData = App\Enums\CommercialComplaintSource::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($source->value); ?>" <?php if(old('source', $record?->source?->value ?? 'other') === $source->value): echo 'selected'; endif; ?>><?php echo e($source->label()); ?></option>
    ...
    <?php if(($fields['priority']['visible'] ?? true)): ?>
        <div>
            ...
            <select name="priority" class="erp-input w-full" <?php if($fields['priority']['required'] ?? true): echo 'required'; endif; ?> <?php if($fields['priority']['read_only'] ?? false): echo 'disabled'; endif; ?>>
                <?php $__currentLoopData = App\Enums\CommercialComplaintPriority::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\commercial\complaints\form.blade.php ENDPATH**/ ?>