...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('CRM'),'breadcrumbs' => [['label' => __('CRM')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('CRM'),'description' => __('Customer relationships, leads, and follow-ups.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('CRM')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Customer relationships, leads, and follow-ups.'))]); ?>
...
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([])]); ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Crm\Customer::class)): ?>
                <a href="<?php echo e(route('admin.crm.customers.create')); ?>" class="erp-btn-primary"><?php echo e(__('New customer')); ?></a>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Crm\Lead::class)): ?>
                <a href="<?php echo e(route('admin.crm.leads.create')); ?>" class="erp-btn-secondary"><?php echo e(__('New lead')); ?></a>
            <?php endif; ?>
            <a href="<?php echo e(route('admin.crm.customers.index')); ?>" class="erp-btn-secondary"><?php echo e(__('All customers')); ?></a>
            <a href="<?php echo e(route('admin.crm.leads.index')); ?>" class="erp-btn-secondary"><?php echo e(__('All leads')); ?></a>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\dashboard.blade.php ENDPATH**/ ?>