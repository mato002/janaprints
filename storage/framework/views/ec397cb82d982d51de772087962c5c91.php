    ...
    <div class="space-y-4">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <?php if($invoice->salesOrder): ?>
                <a href="<?php echo e(route('admin.sales.desk', ['customer' => $invoice->customer?->getRouteKey(), 'order' => $invoice->salesOrder->getRouteKey(), 'step' => 4])); ?>" class="erp-btn-secondary text-sm" data-turbo-frame="erp-main"><?php echo e(__('Back to desk')); ?></a>
            <?php endif; ?>
        </div>
    </div>
