<?php $__env->startSection('page-title', 'Client Login'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="login-scene" aria-hidden="false">
        ...
        <main class="login-scene__main" aria-label="<?php echo e(__('Client Login')); ?>">
            <div class="login-card" data-login-card>
                ...
                <?php if(! empty($staffSessionActive)): ?>
                    <div class="login-alert" role="status">
                        <?php echo e(__('You are signed in to the ERP. Submitting this form will switch to a client portal session.')); ?>
                ...
                <form method="POST" action="<?php echo e(route('client.login')); ?>" class="login-form" novalidate>
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="login-form__meta">
                        ...
                        <?php if(Route::has('client.password.request')): ?>
                            <a href="<?php echo e(route('client.password.request')); ?>" class="login-form__forgot"><?php echo e(__('Forgot Password')); ?></a>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.auth-login', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\auth\client-login.blade.php ENDPATH**/ ?>