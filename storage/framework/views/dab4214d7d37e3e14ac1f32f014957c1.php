...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        <label class="erp-label" for="code"><?php echo e(__('Code')); ?></label>
        <input id="code" name="code" class="erp-input w-full font-mono uppercase" value="<?php echo e(old('code', $wc?->code)); ?>" required maxlength="30">
