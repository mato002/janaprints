...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Payments'),'breadcrumbs' => [['label' => __('Accounting'), 'url' => route('admin.workspaces.accounting')], ['label' => __('Payments')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Customer payments')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Customer payments'))]); ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Sales\CustomerPayment::class)): ?>
            <a href="<?php echo e(route('admin.payments.create')); ?>" class="erp-btn-primary"><?php echo e(__('Record payment')); ?></a>
        <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['exportRoute' => 'admin.accounting.exports','exportRouteParams' => ['listing' => 'customer-payments'],'exportQuery' => request()->query(),'formatInPath' => true,'exportFilename' => 'customer-payments']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['export-route' => 'admin.accounting.exports','export-route-params' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['listing' => 'customer-payments']),'export-query' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->query()),'format-in-path' => true,'export-filename' => 'customer-payments']); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr
                    ...
                    role="link"
                    tabindex="0"
                    aria-label="<?php echo e(__('Open payment :number', ['number' => $payment->payment_number])); ?>"
                ...
                >
                    <td class="font-mono text-erp-accent"><?php echo e($payment->payment_number); ?></td>
                    <td><?php echo e($payment->customer?->company_name); ?></td>
                    <td><?php echo e($payment->payment_date->format('Y-m-d')); ?></td>
                    <td><?php echo e($payment->payment_method->label()); ?><?php if($payment->is_deposit): ?> <span class="erp-badge text-[10px]"><?php echo e(__('Deposit')); ?></span><?php endif; ?></td>
                    <td class="font-mono"><?php echo e(number_format($payment->amount, 2)); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'credit-card','title' => __('No payments yet')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'credit-card','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No payments yet'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\sales\payments\index.blade.php ENDPATH**/ ?>