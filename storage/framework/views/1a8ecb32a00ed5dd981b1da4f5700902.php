<a href="<?php echo e(route('admin.production.job-cards.show', $item)); ?>" class="flex items-center justify-between gap-2 border-b border-erp-border py-2 text-sm last:border-0 hover:bg-erp-page/50" data-turbo-frame="erp-main">
    <span class="font-medium text-erp-primary"><?php echo e($item->job_card_number); ?></span>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\workspace\partials\recent-job-row.blade.php ENDPATH**/ ?>