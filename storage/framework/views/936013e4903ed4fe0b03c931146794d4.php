...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.index-toolbar','data' => ['action' => $hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'handovers'])),'resetUrl' => $hubUrl . '?tab=handovers']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'handovers']))),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?tab=handovers')]); ?>
...
<?php $component->withAttributes(['icon' => 'clipboard-list','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No handovers yet')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Create a handover to formally transfer custody evidence.'))]); ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Assets\AssetHandover::class)): ?>
                             <?php $__env->slot('action', null, []); ?> 
                                <a href="<?php echo e(route('admin.assets.custody.handovers.create')); ?>" class="erp-btn-primary" data-erp-modal-open><?php echo e(__('New handover')); ?></a>
                             <?php $__env->endSlot(); ?>
                        <?php endif; ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\custody\partials\tabs\handovers.blade.php ENDPATH**/ ?>