...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Journals'),'breadcrumbs' => [['label' => __('Accounting'), 'url' => route('admin.workspaces.accounting')], ['label' => __('Journals')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Journal entries')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Journal entries'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Accounting\Journal::class)): ?>
                <a href="<?php echo e(route('admin.accounting.journals.create')); ?>" class="erp-btn-primary"><?php echo e(__('New journal')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['searchPlaceholder' => __('Search journals…'),'exportRoute' => 'admin.accounting.exports','exportRouteParams' => ['listing' => 'journals'],'exportQuery' => request()->query(),'formatInPath' => true,'exportFilename' => 'journals']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['search-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search journals…')),'export-route' => 'admin.accounting.exports','export-route-params' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['listing' => 'journals']),'export-query' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->query()),'format-in-path' => true,'export-filename' => 'journals']); ?>
         <?php $__env->slot('head', null, []); ?> 
            <tr>
                <th scope="col"><?php echo e(__('Number')); ?></th>
                <th scope="col"><?php echo e(__('Date')); ?></th>
                <th scope="col" class="hidden md:table-cell"><?php echo e(__('Period')); ?></th>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr x-show="rowVisible(<?php echo \Illuminate\Support\Js::from(strtolower($journal->journal_number.' '.$journal->reference.' '.$journal->status->value))->toHtml() ?>)">
                    <td>
                        <a href="<?php echo e(route('admin.accounting.journals.show', $journal)); ?>" class="font-mono text-sm text-erp-accent"><?php echo e($journal->journal_number); ?></a>
                        <?php if($journal->entry_type === App\Enums\JournalEntryType::System): ?>
                            <span class="erp-badge text-[10px]"><?php echo e(__('System')); ?></span>
                        <?php elseif($journal->entry_type === App\Enums\JournalEntryType::Reversal): ?>
                            <span class="erp-badge text-[10px]"><?php echo e(__('Reversal')); ?></span>
                        <?php endif; ?>
                    </td>
                    <td class="text-sm"><?php echo e($journal->journal_date->format('Y-m-d')); ?></td>
                    <td class="hidden md:table-cell text-sm text-slate-600"><?php echo e($journal->accountingPeriod?->code); ?></td>
                    <td class="text-sm font-mono"><?php echo e(number_format($journal->total_debit, 2)); ?></td>
                    <td class="text-sm font-mono"><?php echo e(number_format($journal->total_credit, 2)); ?></td>
                    <td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.accounting.journals.show', $journal)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.accounting.journals.show', $journal))]); ?><?php echo e(__('View')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'document-text','title' => __('No journals yet')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'document-text','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No journals yet'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-pagination','data' => ['paginator' => $journals]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($journals)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\accounting\journals\index.blade.php ENDPATH**/ ?>