...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Deduction Library'),'breadcrumbs' => [['label' => __('HR'), 'url' => route('admin.workspaces.hr')], ['label' => __('Compensation'), 'url' => route('admin.hr.compensation.dashboard')], ['label' => __('Deductions')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Deduction Library'),'description' => __('PAYE, NSSF, SHIF, housing levy, advances, loans, and custom deduction definitions.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Deduction Library')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('PAYE, NSSF, SHIF, housing levy, advances, loans, and custom deduction definitions.'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Hr\EmployeeCompensation::class)): ?>
                <a href="<?php echo e(route('admin.hr.compensation.deductions.create')); ?>" class="erp-btn-primary" data-erp-modal-open><?php echo e(__('Add deduction')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $definitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $definition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e(strtoupper($definition->category)); ?></td>
                    <td><?php echo e($definition->calculation_type?->label()); ?></td>
                    <td><?php echo e(number_format($definition->default_amount, 2)); ?></td>
                </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['title' => __('No deduction definitions yet')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No deduction definitions yet'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\compensation\deductions.blade.php ENDPATH**/ ?>