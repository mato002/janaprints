...
<?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dispatch', $note)): ?>
                    <form method="POST" action="<?php echo e(route('admin.dispatch.delivery-notes.dispatch', $note)); ?>" class="space-y-2 rounded-lg border border-erp-border p-3">
                        <?php echo csrf_field(); ?>
                        ...
                        <select name="courier_key" class="erp-input text-sm">
                            <option value=""><?php echo e(__('Select courier')); ?></option>
                            <?php $__currentLoopData = $couriers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php if(old('courier_key') === $key): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <input type="text" name="tracking_number" class="erp-input text-sm" placeholder="<?php echo e(__('Tracking number')); ?>" value="<?php echo e(old('tracking_number', $note->tracking_number)); ?>">
                        <input type="text" name="waybill_number" class="erp-input text-sm" placeholder="<?php echo e(__('Waybill number')); ?>" value="<?php echo e(old('waybill_number', $note->waybill_number)); ?>">
                        <textarea name="dispatch_notes" rows="2" class="erp-input text-sm" placeholder="<?php echo e(__('Dispatch notes')); ?>"><?php echo e(old('dispatch_notes', $note->dispatch_notes)); ?></textarea>
                        <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['type' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('primary-button'); ?>
...
<?php endif; ?>
            ...
            <?php if($salesOrderInvoices->isNotEmpty()): ?>
                <div class="mt-3 border-t border-slate-100 pt-3">
                    <p class="mb-1 text-xs font-medium text-slate-600"><?php echo e(__('Sales order invoices')); ?></p>
                        ...
                        <?php $__currentLoopData = $salesOrderInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soInvoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                ...
                                <?php if((int) $soInvoice->delivery_note_id === (int) $note->id): ?>
                                    <span class="text-slate-500">(<?php echo e(__('this delivery')); ?>)</span>
                                <?php elseif($soInvoice->delivery_note_id): ?>
                                    <span class="text-slate-500">(<?php echo e(__('other delivery')); ?>)</span>
                                <?php else: ?>
                                    <span class="text-amber-700">(<?php echo e(__('from order — not linked here')); ?>)</span>
                                <?php endif; ?>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    ...
                    <?php if($note->productionJobCard): ?>
                        <li>
                            <a href="<?php echo e(route('admin.production.job-cards.show', ['jobCard' => $note->productionJobCard, 'tab' => 'outputs'])); ?>" class="font-medium text-erp-primary hover:underline">
                                <?php echo e(__('Open job → Finished goods')); ?>
            ...
            <?php endif; ?>
            <?php if(! empty($invoiceEligibility['blockers'])): ?>
