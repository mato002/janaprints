                ...
                <div class="mb-3 flex items-center justify-between gap-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('maintenance.view')): ?>
                        <?php if(Route::has('admin.assets.maintenance.work-orders.index')): ?>
                            <a href="<?php echo e(route('admin.assets.maintenance.work-orders.index', ['search' => $asset->asset_number])); ?>" class="text-xs text-erp-accent hover:underline"><?php echo e(__('Work Orders')); ?></a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
