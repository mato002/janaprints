...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal-form','data' => ['title' => $issue->issue_number,'maxWidth' => '4xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($issue->issue_number),'maxWidth' => '4xl']); ?>
    <div class="space-y-4">
        <div class="flex flex-wrap items-center gap-2">
            <span class="erp-badge"><?php echo e($issue->status->value); ?></span>
            <span class="text-sm text-slate-600"><?php echo e($issue->warehouse?->name); ?> · <?php echo e($issue->issue_date->format('d M Y')); ?></span>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\store\desk\issue-modal.blade.php ENDPATH**/ ?>