...
<nav class="mb-4 flex flex-wrap gap-1 border-b border-erp-border" aria-label="<?php echo e(__('Funnel tabs')); ?>">
    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $query = array_merge($filters, ['tab' => $tab['key']]);
        ?>
        <a
            href="<?php echo e(\App\Support\Navigation\WorkspaceEmbed::url(route('admin.commercial.reports.conversion.index', $query))); ?>"
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\commercial\reports\conversion\partials\tabs.blade.php ENDPATH**/ ?>