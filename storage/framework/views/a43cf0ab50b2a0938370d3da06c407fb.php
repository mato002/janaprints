...
<?php $component->withAttributes([]); ?>
            <div class="mb-4 flex justify-between">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Accounting\Invoice::class)): ?>
                    <a href="<?php echo e(route('admin.accounting.invoices.create', ['customer_id' => $customer->id])); ?>" class="erp-btn-primary text-sm"><?php echo e(__('New invoice')); ?></a>
                <?php endif; ?>
            </div>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-3 py-2"><a href="<?php echo e(route('admin.accounting.invoices.show', $invoice)); ?>" class="font-mono text-indigo-600"><?php echo e($invoice->invoice_number); ?></a></td>
