...
<div>
    ...
    <?php if($rows === []): ?>
        <p class="py-6 text-center text-sm text-slate-500"><?php echo e(__('No data for selected filters.')); ?></p>
    <?php else: ?>
                    ...
                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b border-erp-border/60">
                            <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="px-3 py-2 tabular-nums text-slate-700"><?php echo e($cell); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\procurement\supplier-performance\partials\simple-table.blade.php ENDPATH**/ ?>