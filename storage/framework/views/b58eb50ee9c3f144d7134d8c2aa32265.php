<a href="<?php echo e(route('admin.quotations.show', $item)); ?>" class="flex items-center justify-between gap-2 border-b border-erp-border py-2 text-sm last:border-0 hover:bg-erp-page/50" data-turbo-frame="erp-main">
    <span class="font-medium text-erp-primary"><?php echo e($item->quotation_number); ?></span>
...
<?php endif; ?>
    <span class="tabular-nums text-slate-600"><?php echo e($item->currency); ?> <?php echo e(number_format($item->total_amount, 2)); ?></span>
</a>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\workspace\partials\recent-quotation-row.blade.php ENDPATH**/ ?>