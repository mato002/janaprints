...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Edit Delegation'),'breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
        <form method="POST" action="<?php echo e(route('admin.governance.delegations.update', ['approvalDelegation' => $delegation->id])); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\governance\delegations\edit.blade.php ENDPATH**/ ?>