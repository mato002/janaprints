...
<?php $component->withAttributes(['class' => 'job-360-readiness-panel h-fit']); ?>
    ...
    <ul class="space-y-2">
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="flex items-start justify-between gap-2 text-sm">
                ...
                <?php if(! $item['passed'] && ($item['action'] ?? null)): ?>
    ...
    <?php if($hasPostedOutput): ?>
        <div class="mt-4 border-t border-erp-border pt-3">
            ...
            <?php if($canCreateDeliveryNote): ?>
                <a href="<?php echo e(route('admin.production.job-cards.show', ['jobCard' => $jobCard, 'tab' => 'dispatch'])); ?>" class="mt-1 inline-flex text-sm font-medium text-erp-primary hover:underline" data-turbo-frame="erp-main"><?php echo e(__('Create delivery note')); ?></a>
            <?php elseif($jobCard->status === ProductionJobCardStatus::ReadyForDispatch): ?>
                <a href="<?php echo e(route('admin.production.job-cards.show', ['jobCard' => $jobCard, 'tab' => 'dispatch'])); ?>" class="mt-1 inline-flex text-sm font-medium text-erp-primary hover:underline" data-turbo-frame="erp-main"><?php echo e(__('Review dispatch requirements')); ?></a>
            <?php else: ?>
                <p class="mt-1 text-sm text-slate-600"><?php echo e(__('Dispatch unlocks after finished goods are posted and all dispatch requirements are met.')); ?></p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
