...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.index-toolbar','data' => ['action' => $hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'work-orders'])),'resetUrl' => $hubUrl . '?tab=work-orders']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'work-orders']))),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?tab=work-orders')]); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\maintenance\partials\tabs\work_orders.blade.php ENDPATH**/ ?>