...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal-form','data' => ['title' => __('New deduction type'),'breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('New deduction type')),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => __('HR'), 'url' => route('admin.workspaces.hr')],
        ['label' => __('Compensation'), 'url' => route('admin.hr.compensation.dashboard')],
        ['label' => __('Deductions'), 'url' => route('admin.hr.compensation.deductions')],
        ['label' => __('New')],
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-shell','data' => ['action' => route('admin.hr.compensation.deductions.store')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.compensation.deductions.store'))]); ?>
        <div class="grid gap-4 sm:grid-cols-2">
            <div>
                <label class="erp-label" for="deduction-code"><?php echo e(__('Code')); ?></label>
                <input type="text" id="deduction-code" name="code" class="erp-input w-full" value="<?php echo e(old('code')); ?>" required>
            </div>
            <div>
                <label class="erp-label" for="deduction-name"><?php echo e(__('Name')); ?></label>
                <input type="text" id="deduction-name" name="name" class="erp-input w-full" value="<?php echo e(old('name')); ?>" required>
            </div>
            <div>
                <label class="erp-label" for="deduction-category"><?php echo e(__('Category')); ?></label>
                <input type="text" id="deduction-category" name="category" class="erp-input w-full" value="<?php echo e(old('category', 'custom')); ?>">
            </div>
            <div>
                <label class="erp-label" for="deduction-calculation-type"><?php echo e(__('Calculation type')); ?></label>
            ...
            <div>
                <label class="erp-label" for="deduction-frequency"><?php echo e(__('Frequency')); ?></label>
            ...
            <div>
                <label class="erp-label" for="deduction-default-amount"><?php echo e(__('Default amount')); ?></label>
                <input type="number" step="0.01" min="0" id="deduction-default-amount" name="default_amount" class="erp-input w-full" value="<?php echo e(old('default_amount', 0)); ?>">
            </div>
        </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('Add deduction')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\compensation\deductions\create.blade.php ENDPATH**/ ?>