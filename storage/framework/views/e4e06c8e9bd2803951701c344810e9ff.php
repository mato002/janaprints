...
<?php $component->withAttributes([]); ?>
    ...
    <?php if(! empty($snapshot['trend'])): ?>
        <div class="mt-3 border-t border-erp-border pt-3">
            <p class="mb-2 text-[10px] uppercase tracking-wide text-slate-400"><?php echo e(__('Attendance Trend (7 days)')); ?></p>
            <div class="exec-bar-chart exec-bar-chart--tall" role="img" aria-label="<?php echo e(__('Attendance trend')); ?>">
                <?php $__currentLoopData = $snapshot['trend']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="exec-bar-chart__col" title="<?php echo e($point['label']); ?>: <?php echo e(number_format($point['value'], 1)); ?>%">
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Desktop\Newfolder\janaprints\resources\views/admin/hr/dashboard/partials/module-snapshot.blade.php ENDPATH**/ ?>