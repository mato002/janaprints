...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['title' => __('Access restricted'),'description' => __('You need dispatch view permission.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Access restricted')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('You need dispatch view permission.'))]); ?>
...
<?php $component->withAttributes(['searchable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'exportable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'filterable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
         <?php $__env->slot('head', null, []); ?> 
            <tr>
                ...
                <th><?php echo e(__('Sales order')); ?></th>
            </tr>
         <?php $__env->endSlot(); ?>
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e($note->delivery_date->format('M j, Y')); ?></td>
...
<?php endif; ?></td>
                    <td>
                        <?php if($note->productionJobCard): ?>
                            <a href="<?php echo e(route('admin.production.job-cards.show', $note->productionJobCard)); ?>"><?php echo e($note->productionJobCard->job_card_number); ?></a>
                        <?php else: ?>
                            —
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($note->salesOrder?->order_number ?? '—'); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="5" class="py-8 text-center text-slate-500"><?php echo e(__('No delivery history.')); ?></td></tr>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\workspace\tabs\deliveries.blade.php ENDPATH**/ ?>