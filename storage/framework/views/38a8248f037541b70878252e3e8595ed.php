...
<?php $component->withAttributes([]); ?>
    <div class="grid gap-3 sm:grid-cols-2">
        <label class="block text-sm">
            ...
            <?php if($template): ?>
                <input name="code" value="<?php echo e(old('code', $template->code)); ?>" class="erp-input w-full font-mono" disabled>
            <?php else: ?>
                <input name="code" value="<?php echo e(old('code')); ?>" class="erp-input w-full font-mono" placeholder="<?php echo e(__('Auto-generated')); ?>">
            <?php endif; ?>
        </label>
        <label class="block text-sm">
