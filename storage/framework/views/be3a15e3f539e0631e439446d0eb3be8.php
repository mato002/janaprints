...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['filters', 'branches', 'customers', 'salespersons']));
...
foreach (array_filter((['filters', 'branches', 'customers', 'salespersons']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.index-toolbar','data' => ['action' => route('admin.commercial.reports.sales_orders.index'),'resetUrl' => route('admin.commercial.reports.sales_orders.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.commercial.reports.sales_orders.index')),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.commercial.reports.sales_orders.index'))]); ?>
        ...
        <select id="quotation_source" name="quotation_source" class="erp-toolbar-select" aria-label="<?php echo e(__('Quotation source')); ?>">
            <option value=""><?php echo e(__('All sources')); ?></option>
            <option value="from_quotation" <?php if(($filters['quotation_source'] ?? '') === 'from_quotation'): echo 'selected'; endif; ?>><?php echo e(__('From quotation')); ?></option>
            <option value="direct" <?php if(($filters['quotation_source'] ?? '') === 'direct'): echo 'selected'; endif; ?>><?php echo e(__('Direct order')); ?></option>
        </select>
        <input
            type="search"
            id="search"
            ...
            placeholder="<?php echo e(__('Order number or customer name…')); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.status-pills','data' => ['options' => collect(SalesOrderStatus::cases())->map(fn ($status) => ['value' => $status->value, 'label' => ucfirst(str_replace('_', ' ', $status->value))])->prepend(['value' => '', 'label' => __('All statuses')])->all(),'param' => 'status','current' => $filters['status'] ?? '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(collect(SalesOrderStatus::cases())->map(fn ($status) => ['value' => $status->value, 'label' => ucfirst(str_replace('_', ' ', $status->value))])->prepend(['value' => '', 'label' => __('All statuses')])->all()),'param' => 'status','current' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($filters['status'] ?? '')]); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\commercial\reports\sales-orders\partials\filters.blade.php ENDPATH**/ ?>