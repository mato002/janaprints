        ...
        <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $href = isset($link['route_params'])
                    ...
                    : route($link['route']);
            ?>
            <a href="<?php echo e($href); ?>" class="erp-card block p-5 transition hover:border-erp-primary/40 hover:shadow-sm" data-turbo-frame="erp-main">
                <h3 class="text-base font-semibold text-slate-900"><?php echo e($link['label']); ?></h3>
                <p class="mt-1 text-sm text-slate-600"><?php echo e($link['description']); ?></p>
                <span class="mt-3 inline-flex text-sm font-medium text-erp-primary"><?php echo e(__('Open')); ?> →</span>
            </a>
