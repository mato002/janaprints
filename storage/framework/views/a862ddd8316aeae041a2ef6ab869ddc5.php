...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.crm-btn','data' => ['variant' => 'ghost','size' => 'sm','href' => route('admin.crm.customers.index'),'class' => '!px-2.5','dataTurboFrame' => 'erp-main']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'ghost','size' => 'sm','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.crm.customers.index')),'class' => '!px-2.5','data-turbo-frame' => 'erp-main']); ?>← <?php echo e(__('Customers')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <p class="crm-360__since">
                <?php echo e(__('Customer since')); ?> <?php echo e($customer->created_at?->format('M Y') ?? '—'); ?>

            </p>
            <span class="crm-360__status crm-360__status--<?php echo e($customer->status->value); ?>">
                <?php echo e(strtoupper($customer->status->value)); ?>
