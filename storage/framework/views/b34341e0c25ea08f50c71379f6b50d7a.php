...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Intelligence Settings'),'breadcrumbs' => [
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Intelligence Settings'),'description' => __('Read-only view of velocity intelligence thresholds (config/inventory_intelligence.php).')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Intelligence Settings')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Read-only view of velocity intelligence thresholds (config/inventory_intelligence.php).'))]); ?>
...
<?php $component->withAttributes([]); ?>
        <dl class="grid grid-cols-1 gap-4 md:grid-cols-2 text-sm">
            <?php $__currentLoopData = [
                ...
                <div>
                    <dt class="text-xs font-medium text-slate-500"><?php echo e($label); ?></dt>
                    <dd class="mt-1 font-medium text-slate-900"><?php echo e($value); ?></dd>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\inventory\intelligence\settings.blade.php ENDPATH**/ ?>