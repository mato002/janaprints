...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => $operatorMode ? __('Operator Floor') : __('Production Floor'),'breadcrumbs' => $operatorMode
        ...
        ],'compactPage' => false,'compactWorkspace' => $operatorMode || $activeFloorView === ProductionFloorDeskViews::QUEUE] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
        ...
        <?php if($operatorMode): ?>
            <?php if (! ($activeFloorView === ProductionFloorDeskViews::QUEUE)): ?>
                <div class="production-floor-operator-banner">
                    <span class="production-floor-operator-banner__label"><?php echo e(__('Operator mode')); ?></span>
                    <span class="production-floor-operator-banner__sep" aria-hidden="true">•</span>
                    <span><?php echo e(__('Choose Offset, Digital, or Outsourced')); ?></span>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
        ...
        <?php if(session('status')): ?>
            <div class="mb-2 rounded-md border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-sm text-emerald-800"><?php echo e(session('status')); ?></div>
        <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-pagination','data' => ['paginator' => $jobs,'turboFrame' => 'erp-main']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($jobs),'turbo-frame' => 'erp-main']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
