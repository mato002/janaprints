...
<?php $component->withAttributes([]); ?>
    <div
        ...
        x-data="{
            ...
            overflowIds: [],
            measuring: false,
            tabLabels: <?php echo \Illuminate\Support\Js::from($crm360Tabs)->toHtml() ?>,
            setTab(id) {
                this.tab = id;
            ...
            moreLabel() {
                ...
                return <?php echo \Illuminate\Support\Js::from(__('More'))->toHtml() ?>;
            },
            async measureTabs() {
    ...
    >
        ...
        <nav
            class="crm-360__tabs"
            x-ref="tabNav"
            aria-label="<?php echo e(__('Customer workspace tabs')); ?>"
        >
            <?php $__currentLoopData = $crm360Tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button
                    type="button"
                    class="crm-360__tab"
                    data-crm-tab="<?php echo e($id); ?>"
                    x-show="tabVisible(<?php echo \Illuminate\Support\Js::from($id)->toHtml() ?>)"
