...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['searchPlaceholder' => __('Search payments…'),'exportFilename' => 'customer-payments']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['search-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search payments…')),'export-filename' => 'customer-payments']); ?>
         <?php $__env->slot('head', null, []); ?> 
            <tr>
                <th><?php echo e(__('Payment')); ?></th>
                <th><?php echo e(__('Date')); ?></th>
                <th class="text-right"><?php echo e(__('Amount')); ?></th>
                <th class="text-right"><?php echo e(__('Allocated')); ?></th>
                <th class="text-right"><?php echo e(__('Unallocated')); ?></th>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                ?>
                <tr x-show="rowVisible(<?php echo \Illuminate\Support\Js::from(strtolower($payment->payment_number))->toHtml() ?>)">
                    <td>
                        <a href="<?php echo e(route('admin.accounting.payments.show', $payment)); ?>" class="font-mono text-indigo-600 hover:text-indigo-800">
                            <?php echo e($payment->payment_number); ?>

                        </a>
                    </td>
                    <td><?php echo e($payment->payment_date->format('M j, Y')); ?></td>
                    <td class="text-right font-mono"><?php echo e(number_format($payment->amount, 2)); ?></td>
                    <td class="text-right font-mono"><?php echo e(number_format($allocated, 2)); ?></td>
                    <td class="text-right font-mono"><?php echo e(number_format($payment->unallocated_amount, 2)); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.enum-status-badge','data' => ['status' => $payment->status->value]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($payment->status->value)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (isset($attributes)) { $__attributesOriginal99089f8e2ef4184d7d35db81d60c6521 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'credit-card','title' => __('No payments recorded')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.empty-state'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'credit-card','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No payments recorded'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal99089f8e2ef4184d7d35db81d60c6521)): ?>
<?php $attributes = $__attributesOriginal99089f8e2ef4184d7d35db81d60c6521; ?>
...
<?php endif; ?></td></tr>
         ...
         <?php $__env->slot('footer', null, []); ?> 
            <?php if($payments && method_exists($payments, 'links')): ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\workspace\tabs\payments.blade.php ENDPATH**/ ?>