...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.media-image','data' => ['src' => $member['photo'],'alt' => $member['alt'],'fallback' => 'portrait','class' => 'h-full w-full object-cover']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['src' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($member['photo']),'alt' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($member['alt']),'fallback' => 'portrait','class' => 'h-full w-full object-cover']); ?>
...
<?php endif; ?>
    ...
    <div class="public-facility-team__body">
        <h4 class="public-facility-team__name"><?php echo e($member['name']); ?></h4>
        <p class="public-facility-team__role"><?php echo e($member['role']); ?></p>
        <p class="public-facility-team__bio"><?php echo e($member['bio']); ?></p>
    </div>
</article>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\public\facility-team-card.blade.php ENDPATH**/ ?>