...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($description)]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <span class="erp-badge bg-slate-100 text-slate-700"><?php echo e(__('Workforce analytics')); ?></span>
            <?php if($can_export): ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('admin.reports.hr.partials.filters', [
        'filters' => $filters,
        'branches' => $branches,
    ...
    <?php echo $__env->make('admin.reports.hr.partials.catalog', ['catalog' => $catalog], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('admin.reports.hr.partials.tabs', [
        'tabs' => $tabs,
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\reports\hr\index.blade.php ENDPATH**/ ?>