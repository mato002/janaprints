     ...
     <?php $__env->slot('body', null, []); ?> 
        <?php $__empty_1 = true; $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo e(WorkspaceEmbed::url(route('admin.hr.recruitment.vacancies.show', $vacancy))); ?>" class="font-medium text-erp-primary hover:underline">
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/hr/recruitment/partials/workspace-vacancies.blade.php ENDPATH**/ ?>