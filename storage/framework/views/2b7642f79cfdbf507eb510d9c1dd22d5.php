...
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($action),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($resetUrl)]); ?>
        <input type="date" name="as_of_date" value="<?php echo e($filters['as_of_date'] ?? ''); ?>" class="erp-toolbar-input" aria-label="<?php echo e($submitLabel); ?>" required>
        <?php if($periodOptional && count($periods) > 0): ?>
            <select name="period_id" class="erp-toolbar-select" aria-label="<?php echo e($periodLabel); ?>">
                <option value=""><?php echo e($nonePeriodLabel); ?></option>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\accounting\partials\as-of-toolbar.blade.php ENDPATH**/ ?>