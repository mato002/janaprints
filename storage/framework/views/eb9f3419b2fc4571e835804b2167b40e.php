<a href="<?php echo e(route('admin.artwork.show', $item)); ?>" class="flex items-center justify-between gap-2 border-b border-erp-border py-2 text-sm last:border-0 hover:bg-erp-page/50" data-turbo-frame="erp-main">
    <span class="font-medium text-erp-primary"><?php echo e($item->request_number); ?></span>
...
<?php endif; ?>
    <span class="text-xs text-slate-500">v<?php echo e($item->current_version); ?></span>
</a>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\workspace\partials\recent-artwork-row.blade.php ENDPATH**/ ?>