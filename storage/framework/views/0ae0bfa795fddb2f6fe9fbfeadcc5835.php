...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal-form','data' => ['title' => __('Create role'),'breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Create role')),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => __('Roles'), 'url' => route('admin.access-control.roles')],
        ['label' => __('Create')],
    ]),'maxWidth' => 'lg']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-shell','data' => ['action' => route('admin.roles.store')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.roles.store'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.input','data' => ['name' => 'name','label' => __('Role name'),'value' => old('name'),'required' => true,'colSpan' => 2,'placeholder' => ''.e(__('e.g. Production Supervisor')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'name','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Role name')),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('name')),'required' => true,'colSpan' => 2,'placeholder' => ''.e(__('e.g. Production Supervisor')).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-field','data' => ['name' => 'clone_from','label' => __('Clone from existing role'),'colSpan' => 2,'help' => __('Copies permissions only. Users are never cloned.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'clone_from','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Clone from existing role')),'colSpan' => 2,'help' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Copies permissions only. Users are never cloned.'))]); ?>
                <select id="clone_from" name="clone_from" class="erp-select w-full">
                    <option value=""><?php echo e(__('Start without permissions')); ?></option>
                    <?php $__currentLoopData = $cloneOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($option->id); ?>" <?php if(old('clone_from') == $option->id): echo 'selected'; endif; ?>>
                            <?php echo e($option->name); ?>

                            <?php if($option->permissions_count > 0): ?>
                                (<?php echo e($option->permissions_count); ?> <?php echo e(__('permissions')); ?>)
                            <?php endif; ?>
                        </option>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('Create role')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\roles\create.blade.php ENDPATH**/ ?>