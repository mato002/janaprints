...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.index-toolbar','data' => ['action' => $hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'assignments'])),'resetUrl' => $hubUrl . '?tab=assignments']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'assignments']))),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?tab=assignments')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['searchPlaceholder' => __('Search assignments…'),'exportFilename' => 'asset-assignments']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['search-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search assignments…')),'export-filename' => 'asset-assignments']); ?>
     <?php $__env->slot('head', null, []); ?> 
        <tr>
            ...
            <th scope="col"><?php echo e(__('Expected return')); ?></th>
            <th scope="col"><?php echo e(__('Assigned at')); ?></th>
     ...
     <?php $__env->slot('body', null, []); ?> 
        <?php $__empty_1 = true; $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr x-show="rowVisible(<?php echo \Illuminate\Support\Js::from($search)->toHtml() ?>)">
                <td>
                    <span class="font-medium"><?php echo e($assignment->asset?->asset_number); ?></span>
                    <span class="text-slate-500"> — <?php echo e($assignment->asset?->asset_name); ?></span>
                </td>
                <td><?php echo e(ucfirst($assignment->assignment_type->value)); ?></td>
                <td><?php echo e($assignee !== '' ? $assignee : '—'); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.status-badge','data' => ['variant' => $assignment->status->badgeVariant()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($assignment->status->badgeVariant())]); ?><?php echo e($assignment->status->label()); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></td>
                <td><?php echo e($assignment->expected_return_date?->format('Y-m-d') ?? '—'); ?></td>
                <td class="whitespace-nowrap"><?php echo e($assignment->assigned_at?->format('Y-m-d H:i')); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.assets.show', $assignment->asset)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.assets.show', $assignment->asset))]); ?><?php echo e(__('View asset')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'clipboard-list','title' => __('No assignments yet'),'description' => __('Assign an asset to an employee or department to start custody tracking.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'clipboard-list','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No assignments yet')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Assign an asset to an employee or department to start custody tracking.'))]); ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assets.assign')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-modal-link','data' => ['href' => route('admin.assets.custody.assignments.create')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.assets.custody.assignments.create'))]); ?><?php echo e(__('New assignment')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-pagination','data' => ['paginator' => $assignments]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($assignments)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\custody\partials\tabs\assignments.blade.php ENDPATH**/ ?>