...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Exit Processes'),'breadcrumbs' => [['label' => __('HR'), 'url' => route('admin.workspaces.hr')], ['label' => __('Exit Management'), 'url' => route('admin.hr.exit.dashboard')], ['label' => __('Processes')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Exit Processes')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Exit Processes'))]); ?>
         <?php $__env->slot('secondary', null, []); ?> 
            <a href="<?php echo e(route('admin.hr.exit.dashboard')); ?>" class="erp-btn-secondary"><?php echo e(__('Dashboard')); ?></a>
         <?php $__env->endSlot(); ?>
...
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url()->current()),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url()->current())]); ?>
            ...
            <select name="exit_type" class="erp-toolbar-select" aria-label="<?php echo e(__('Exit Type')); ?>">
                ...
                <?php $__currentLoopData = $formData['exitTypes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($type->value); ?>" <?php if(($filters['exit_type'] ?? '') === $type->value): echo 'selected'; endif; ?>><?php echo e($type->label()); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['exportFilename' => 'employee-exits']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['export-filename' => 'employee-exits']); ?>
         <?php $__env->slot('head', null, []); ?> 
            <tr>
                <th><?php echo e(__('Reference')); ?></th>
                <th><?php echo e(__('Employee')); ?></th>
                <th><?php echo e(__('Type')); ?></th>
                <th><?php echo e(__('Last Day')); ?></th>
                <th><?php echo e(__('Net Dues')); ?></th>
                <th><?php echo e(__('Status')); ?></th>
            </tr>
         <?php $__env->endSlot(); ?>
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $exits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><a href="<?php echo e(route('admin.hr.exit.show', $exit)); ?>" class="font-medium text-indigo-600 hover:underline"><?php echo e($exit->reference); ?></a></td>
                    <td><?php echo e($exit->employee->full_name); ?></td>
                    <td><?php echo e($exit->exit_type->label()); ?></td>
                    <td><?php echo e($exit->last_working_date->format('Y-m-d')); ?></td>
                    <td><?php echo e(number_format($exit->net_final_dues, 2)); ?></td>
                    <td><?php echo e($exit->status->label()); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="6" class="py-6 text-center text-slate-500"><?php echo e(__('No exit processes found.')); ?></td></tr>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="mt-4"><?php echo e($exits->links()); ?></div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\exit\index.blade.php ENDPATH**/ ?>