...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Production outputs'),'breadcrumbs' => [
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Production outputs'),'description' => __('Finished goods completion records posted from production jobs.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Production outputs')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Finished goods completion records posted from production jobs.'))]); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\production\outputs\index.blade.php ENDPATH**/ ?>