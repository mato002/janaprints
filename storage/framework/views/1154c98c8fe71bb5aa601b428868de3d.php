...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($description)]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php echo $__env->make('admin.commercial.reports.artwork.partials.export-actions', [
...
<?php endif; ?>
    ...
    <?php echo $__env->make('admin.commercial.reports.artwork.partials.kpi-strip', ['kpis' => $kpis], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('admin.commercial.reports.artwork.partials.tabs', [
        'tabs' => $tabs,
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\commercial\reports\artwork\index.blade.php ENDPATH**/ ?>