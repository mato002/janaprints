...
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.compensation.allowances.store'))]); ?>
        <div class="grid gap-4 sm:grid-cols-2">
            <div>
                <label class="erp-label" for="allowance-code"><?php echo e(__('Code')); ?></label>
                <input type="text" id="allowance-code" name="code" class="erp-input w-full" value="<?php echo e(old('code')); ?>" required>
            </div>
            <div>
