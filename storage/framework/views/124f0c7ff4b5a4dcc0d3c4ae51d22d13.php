...
<section class="rounded-xl border border-erp-border bg-white shadow-sm" aria-label="<?php echo e(__('Procurement alerts')); ?>">
    <div class="flex items-center justify-between gap-2 border-b border-erp-border px-3 py-2">
        <h2 class="text-sm font-semibold text-slate-900"><?php echo e(__('Procurement')); ?></h2>
        <a
