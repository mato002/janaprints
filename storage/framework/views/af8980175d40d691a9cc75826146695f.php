...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => $deskTitle,'breadcrumbs' => $operatorMode
        ? [['label' => __('Sales Desk')]]
        : [
...
<?php $component->withAttributes([]); ?>
    ...
    >
        <?php if (! (WorkspaceEmbed::inWorkspaceContext())): ?>
            <?php echo $__env->make('admin.sales.desk.partials.desk-mode-nav', ['activeSalesView' => $activeSalesView], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>

        <?php if($isPanel): ?>
            <?php echo $__env->make('admin.sales.desk.partials.register-panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php else: ?>
                        ...
                        <?php if($orderPresentation['can_release'] && ! empty($orderPresentation['readiness']['checks'])): ?>
                            ...
                            <div class="mb-4">
                                <div class="mb-2 flex items-center justify-between gap-2">
                                    ...
                                    <?php else: ?>
                                        <span class="rounded-full border border-rose-200 bg-rose-50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-rose-800"><?php echo e(__('Not ready')); ?></span>
                                    <?php endif; ?>
                                </div>
