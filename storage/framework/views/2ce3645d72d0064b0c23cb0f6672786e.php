...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'chart-bar','title' => __('Sales Reports'),'description' => $tab_data['message'] ?? __('No data available.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'chart-bar','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Sales Reports')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tab_data['message'] ?? __('No data available.'))]); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-6']); ?>
        <form method="GET" action="<?php echo e(route('admin.commercial.reports.sales.index')); ?>" x-data="erpIndexFilterForm()" @change="onFieldChange($event)" class="mb-4 flex flex-wrap items-center gap-2" data-turbo-frame="<?php echo e(\App\Support\Navigation\WorkspaceEmbed::turboFrame()); ?>">
            <?php $__currentLoopData = collect($filters)->except(['top_limit', 'top_by', 'page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <select id="top_by" name="top_by" class="erp-toolbar-select" aria-label="<?php echo e(__('Rank by')); ?>">
                <option value="revenue" <?php if(($filters['top_by'] ?? 'revenue') === 'revenue'): echo 'selected'; endif; ?>><?php echo e(__('Revenue')); ?></option>
                <option value="orders" <?php if(($filters['top_by'] ?? '') === 'orders'): echo 'selected'; endif; ?>><?php echo e(__('Orders')); ?></option>
                <option value="lifetime" <?php if(($filters['top_by'] ?? '') === 'lifetime'): echo 'selected'; endif; ?>><?php echo e(__('Lifetime Value')); ?></option>
            </select>
        </form>
...
<?php unset($__componentOriginalad5130b5347ab6ecc017d2f5a278b926); ?>
<?php endif; ?>
<?php elseif(($tab_data['type'] ?? '') === 'lost_orders'): ?>
    <?php $lost = $tab_data['data'] ?? []; ?>
    <div class="grid gap-6 lg:grid-cols-2">
        <?php echo $__env->make('admin.commercial.reports.sales.partials.simple-table', [
...
<?php elseif(($tab_data['type'] ?? '') === 'trends'): ?>
    <?php echo $__env->make('admin.commercial.reports.sales.partials.trends-charts', ['series' => $tab_data['series'] ?? []], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/commercial/reports/sales/partials/tab-content.blade.php ENDPATH**/ ?>