...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($description)]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if(($read_only ?? true) === true): ?>
                <span class="erp-badge bg-slate-100 text-slate-700"><?php echo e(__('Read-only intelligence')); ?></span>
            <?php endif; ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('admin.reports.partials.sections', ['sections' => $sections], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\reports\production-360.blade.php ENDPATH**/ ?>