...
<div class="c360-timeline">
    <div class="c360-timeline__intro mb-4">
        <h3 class="text-sm font-semibold uppercase tracking-wide text-erp-primary"><?php echo e(__('Unified job timeline')); ?></h3>
        <p class="mt-1 text-sm text-slate-600"><?php echo e(__('Chronological audit trail across traceability, operations, materials, quality, dispatch, and communications.')); ?></p>
    </div>

    <?php if(! empty($tabData['communications'])): ?>
...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
            <h4 class="mb-3 text-sm font-semibold text-erp-primary"><?php echo e(__('Email communications')); ?></h4>
...
<?php endif; ?>
    ...
    <details class="workspace-filter-panel c360-timeline__toolbar-panel">
        <summary><?php echo e(__('Timeline filters')); ?></summary>
    <form
        method="GET"
        action="<?php echo e(route('admin.production.job-cards.show', $jobCard)); ?>"
...
<?php endif; ?>
        ...
        <div class="c360-timeline__filters flex flex-wrap gap-1.5" role="tablist" aria-label="<?php echo e(__('Timeline filters')); ?>">
            <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a
                    href="<?php echo e(route('admin.production.job-cards.show', array_filter([
                        'jobCard' => $jobCard,
                        'tab' => 'timeline',
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/production/job-cards/workspace/tabs/timeline.blade.php ENDPATH**/ ?>