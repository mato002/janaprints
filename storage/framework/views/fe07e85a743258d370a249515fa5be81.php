...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['title' => __('Access restricted'),'description' => __('You need production view permission to see this tab.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Access restricted')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('You need production view permission to see this tab.'))]); ?>
...
<?php $component->withAttributes(['searchable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'exportable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'filterable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
         <?php $__env->slot('head', null, []); ?> 
            <tr>
                <th><?php echo e(__('Job number')); ?></th>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    <td>
                        <a href="<?php echo e(route('admin.production.job-cards.show', $job)); ?>" class="font-medium text-erp-accent hover:text-erp-accent-hover" data-turbo-frame="erp-main"><?php echo e($job->job_card_number); ?></a>
                    </td>
                    <td><?php echo e($job->priority->value); ?></td>
...
<?php endif; ?></td>
                    <td><?php echo e($queue?->workCenter?->name ?? '—'); ?></td>
                    <td>
                        <div class="flex items-center gap-2">
                            <div class="h-1.5 min-w-[4rem] flex-1 rounded-full bg-erp-page">
                                <div class="h-1.5 rounded-full bg-erp-accent" style="width: <?php echo e($progress); ?>%"></div>
                            </div>
                            <span class="text-xs tabular-nums text-slate-600"><?php echo e($progress); ?>%</span>
                        </div>
                    </td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="5" class="text-center text-slate-500 py-6"><?php echo e(__('No production jobs for this customer.')); ?></td></tr>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\workspace\tabs\production.blade.php ENDPATH**/ ?>