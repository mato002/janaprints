...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal-form','data' => ['title' => __('New stock receipt'),'breadcrumbs' => $fromStoreDesk
        ? [['label' => __('Store Desk'), 'url' => route('admin.store.desk')], ['label' => __('Receive goods')]]
        : [['label' => __('Receipts'), 'url' => route('admin.inventory.receipts.index')], ['label' => __('Create')]],'maxWidth' => '5xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('New stock receipt')),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($fromStoreDesk
        ? [['label' => __('Store Desk'), 'url' => route('admin.store.desk')], ['label' => __('Receive goods')]]
        : [['label' => __('Receipts'), 'url' => route('admin.inventory.receipts.index')], ['label' => __('Create')]]),'maxWidth' => '5xl']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-shell','data' => ['action' => route('admin.inventory.receipts.store')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.inventory.receipts.store'))]); ?>
        <?php if($fromStoreDesk): ?>
            <input type="hidden" name="from" value="store-desk">
        <?php endif; ?>
        <?php echo $__env->make('admin.inventory.partials.document-header', ['type' => 'receipt', 'warehouses' => $warehouses, 'sources' => $sources, 'formFields' => $formFields], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <button type="submit" name="intent" value="post" class="erp-btn-primary"><?php echo e(__('Receive & post to stock')); ?></button>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/inventory/receipts/create.blade.php ENDPATH**/ ?>