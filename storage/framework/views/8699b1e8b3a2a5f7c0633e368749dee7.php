...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Customers'),'breadcrumbs' => [['label' => __('Commercial'), 'url' => route('admin.workspaces.commercial')], ['label' => __('CRM Desk')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="crm-customers w-full min-w-0 space-y-3 sm:space-y-4">
        <?php echo $__env->make('admin.crm.partials.desk-mode-nav', ['activeCrmView' => 'customers'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <span class="crm-customers__status <?php echo e($statusClass); ?> sm:hidden"><?php echo e(ucfirst($customer->status->value)); ?></span>
