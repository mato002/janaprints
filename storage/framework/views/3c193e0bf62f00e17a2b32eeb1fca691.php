...
<div <?php echo e($attributes->merge(['class' => 'public-empty-state'])); ?> role="status">
    <div class="public-empty-state__icon" aria-hidden="true">
        <?php switch($icon):
            case ('grid'): ?>
    ...
    <h3 class="public-empty-state__title"><?php echo e($title); ?></h3>
    <p class="public-empty-state__desc"><?php echo e($description); ?></p>
    <?php if($slot->isNotEmpty()): ?>
        <div class="public-empty-state__action"><?php echo e($slot); ?></div>
    <?php endif; ?>
</div>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\public\empty-state.blade.php ENDPATH**/ ?>