...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Job Requisitions')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Job Requisitions')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Job Requisitions'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Hr\JobRequisition::class)): ?>
                <a href="<?php echo e(route('admin.hr.recruitment.requisitions.create')); ?>" class="erp-btn-primary"><?php echo e(__('New requisition')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $requisitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><a href="<?php echo e(route('admin.hr.recruitment.requisitions.show', $requisition)); ?>" class="font-medium text-erp-primary hover:underline"><?php echo e($requisition->title); ?></a></td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\recruitment\requisitions\index.blade.php ENDPATH**/ ?>