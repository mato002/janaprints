...
<div class="login-field">
    <label for="<?php echo e($id); ?>" class="login-field__label"><?php echo e($label); ?></label>
    <div class="login-field__input-wrap">
        <input
            ...
            class="login-field__input pr-12 <?php $__errorArgs = [$name];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> aria-describedby="<?php echo e($id); ?>-error" <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
        <p class="login-field__error" id="<?php echo e($id); ?>-error"><?php echo e($message); ?></p>
    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
</div>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\auth\login-password-field.blade.php ENDPATH**/ ?>