...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($action),'max-width' => '4xl']); ?>
    <p class="mb-4 text-sm text-slate-600">
        <?php echo e(__('Creates an HR employee and login so they can be assigned on the production floor immediately.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\lookups\quick-create\operator.blade.php ENDPATH**/ ?>