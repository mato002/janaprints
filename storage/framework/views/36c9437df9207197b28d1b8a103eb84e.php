...
<?php if (isset($component)) { $__componentOriginald632580a64ffc7ae2a9fdfd16806b8a3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald632580a64ffc7ae2a9fdfd16806b8a3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.lookup-select','data' => ['name' => 'subcategory_id','label' => __('Subcategory'),'options' => $subcategoryOptions,'value' => old('subcategory_id', $m?->subcategory_id),'createRoute' => 'admin.inventory.catalogue.subcategories.quick-create','refreshRoute' => 'admin.lookups.subcategories','permission' => 'catalogue.create','modalTitle' => __('Create subcategory'),'optionLabelKey' => 'label','optionValueKey' => 'value','scopeCategoryField' => 'inventory_category_id','selectClass' => 'erp-input w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.lookup-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'subcategory_id','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Subcategory')),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($subcategoryOptions),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('subcategory_id', $m?->subcategory_id)),'create-route' => 'admin.inventory.catalogue.subcategories.quick-create','refresh-route' => 'admin.lookups.subcategories','permission' => 'catalogue.create','modal-title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Create subcategory')),'option-label-key' => 'label','option-value-key' => 'value','scope-category-field' => 'inventory_category_id','select-class' => 'erp-input w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald632580a64ffc7ae2a9fdfd16806b8a3)): ?>
<?php $attributes = $__attributesOriginald632580a64ffc7ae2a9fdfd16806b8a3; ?>
...
<div
    ...
    x-data="{
        categoryId: <?php echo \Illuminate\Support\Js::from((string) old('inventory_category_id', $m?->inventory_category_id ?? ''))->toHtml() ?>,
        attributeCategories: <?php echo \Illuminate\Support\Js::from($attributeCategoryMap)->toHtml() ?>,
...
>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div x-show="matchesCategory(<?php echo \Illuminate\Support\Js::from($attribute->id)->toHtml() ?>)" x-cloak>
