...
<div class="rounded-lg border border-erp-border p-4" x-data="{ materials: <?php echo \Illuminate\Support\Js::from($materialLines)->toHtml() ?>, rawMaterials: <?php echo \Illuminate\Support\Js::from($rawMaterialOptions)->toHtml() ?> }">
    <div class="mb-3 flex items-center justify-between">
