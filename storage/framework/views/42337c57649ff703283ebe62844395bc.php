...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Support Tickets'),'breadcrumbs' => [['label' => __('Commercial')], ['label' => __('Support Tickets')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Support tickets'),'description' => __('Help desk cases and SLA tracking.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Support tickets')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Help desk cases and SLA tracking.'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Commercial\CommercialSupportTicket::class)): ?>
                <a href="<?php echo e(route('admin.commercial.support-tickets.create')); ?>" class="erp-btn-primary"><?php echo e(__('New ticket')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php $component->withAttributes([]); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="font-mono text-sm"><?php echo e($ticket->ticket_number); ?></td>
                    <td><?php echo e($ticket->subject); ?></td>
                    <td><?php echo e($ticket->customer?->company_name ?? '—'); ?></td>
...
<?php endif; ?>
                    ...
                    <td><?php echo e($ticket->due_at?->format('d M Y H:i') ?? '—'); ?></td>
                    <td><a href="<?php echo e(route('admin.commercial.support-tickets.show', $ticket)); ?>" class="erp-btn-secondary text-xs"><?php echo e(__('View')); ?></a></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="7" class="py-8 text-center text-slate-500"><?php echo e(__('No tickets yet.')); ?></td></tr>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/commercial/support-tickets/index.blade.php ENDPATH**/ ?>