...
<?php $component->withAttributes(['class' => 'mb-4','id' => 'upload-file']); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $customer)): ?>
        <form method="POST" action="<?php echo e(route('admin.crm.customers.files.store', $customer)); ?>" enctype="multipart/form-data" data-turbo-frame="_top" class="flex flex-wrap items-end gap-3">
            <?php echo csrf_field(); ?>
