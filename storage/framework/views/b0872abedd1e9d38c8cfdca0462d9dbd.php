    ...
    <div class="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-5">
        <?php $__currentLoopData = $kpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="rounded-lg border border-erp-border/70 p-4">
                <p class="text-[11px] uppercase tracking-wide text-slate-500"><?php echo e($kpi['label']); ?></p>
                <p class="mt-1 text-xl font-bold tabular-nums text-erp-primary"><?php echo e($kpi['value']); ?></p>
                <p class="mt-1 text-xs text-slate-500"><?php echo e($kpi['hint']); ?></p>
                ...
                ]); ?>"><?php echo e(ucfirst($kpi['status'])); ?></span>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\kpi\partials\kpi-strip.blade.php ENDPATH**/ ?>