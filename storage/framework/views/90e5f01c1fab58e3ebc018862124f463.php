<?php
    ...
    $filterAction = WorkspaceEmbed::url(StoreDeskViews::deskUrl(StoreDeskViews::ALERTS));
...
<?php $component->withAttributes(['search-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search SKU or item name…')),'export-filename' => 'reorder-alerts']); ?>
     <?php $__env->slot('filters', null, []); ?> 
        <form method="GET" action="<?php echo e($filterAction); ?>" x-data="erpIndexFilterForm()" @change="onFieldChange($event)" class="flex flex-wrap items-center gap-2" data-turbo-frame="<?php echo e($frame); ?>" data-turbo-action="advance">
...
<?php endif; ?>
            ...
            <?php endif; ?>
            <a href="<?php echo e($resetUrl); ?>" class="erp-btn-ghost py-1 text-xs text-slate-500" data-turbo-frame="<?php echo e($frame); ?>" data-turbo-action="advance"><?php echo e(__('Reset')); ?></a>
        </form>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\inventory\alerts\partials\content.blade.php ENDPATH**/ ?>