<?php if(! empty($summary)): ?>
    <div class="jp-doc__summary">
        <p class="jp-doc__summary-title"><?php echo e($summary['title'] ?? __('Receipt Summary')); ?></p>

        <?php if(! empty($summary['accountSettled'])): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\documents\partials\receipt-summary.blade.php ENDPATH**/ ?>