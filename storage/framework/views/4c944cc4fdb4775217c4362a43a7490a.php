...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Activities'),'breadcrumbs' => [['label' => __('Commercial'), 'url' => route('admin.workspaces.commercial')], ['label' => __('CRM Desk'), 'url' => route('admin.crm.customers.index')], ['label' => __('Activities')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <?php echo $__env->make('admin.crm.partials.desk-mode-nav', ['activeCrmView' => 'activities'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
