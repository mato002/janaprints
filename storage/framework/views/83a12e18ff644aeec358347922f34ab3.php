...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Capitalization Reconciliation'),'breadcrumbs' => [['label' => __('Assets'), 'url' => route('admin.workspaces.assets')], ['label' => __('Capitalization Reconciliation')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Capitalization Reconciliation'),'description' => __('Compare procurement, accounting, and asset register.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Capitalization Reconciliation')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Compare procurement, accounting, and asset register.'))]); ?>
...
<?php endif; ?></td>
                            <td><a href="<?php echo e(route('admin.assets.acquisitions.reconciliation.show', $record)); ?>" class="erp-link"><?php echo e(__('View')); ?></a></td>
                        </tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\acquisitions\reconciliation.blade.php ENDPATH**/ ?>