...
<section class="store-desk-health mb-3 rounded-xl border border-erp-border bg-white p-3 shadow-sm" aria-label="<?php echo e(__('Buy health')); ?>">
    <div class="mb-2 flex flex-wrap items-center justify-between gap-2 px-1">
        <div>
            <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400"><?php echo e(__('Buy health')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/procurement/desk/partials/summary-strip.blade.php ENDPATH**/ ?>