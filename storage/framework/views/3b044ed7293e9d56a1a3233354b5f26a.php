...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name' => 'home']));
...
foreach (array_filter((['name' => 'home']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<svg <?php echo e($attributes->merge(['class' => 'client-icon', 'fill' => 'none', 'viewBox' => '0 0 24 24', 'stroke' => 'currentColor', 'stroke-width' => '1.75', 'aria-hidden' => 'true'])); ?>>
    <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($paths); ?>" />
</svg>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\client\icon.blade.php ENDPATH**/ ?>