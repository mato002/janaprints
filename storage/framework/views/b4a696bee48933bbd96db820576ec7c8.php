...
<?php endif; ?>
    ...
    <?php if(! empty($insights['kpis'])): ?>
        <div class="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <?php $__currentLoopData = $insights['kpis']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('admin.accounting.workspaces.partials.section-widgets', [
        'section' => $section,
        'insights' => $insights,
...
<?php endif; ?>
        ...
        <?php $__currentLoopData = $workspace['groups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <section class="mb-8" x-show="groupVisible(<?php echo \Illuminate\Support\Js::from($group['label'])->toHtml() ?>)" x-cloak>
                <h2 class="mb-3 text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e($group['label']); ?></h2>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\accounting\workspaces\section.blade.php ENDPATH**/ ?>