...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Customer invoices'),'breadcrumbs' => [['label' => __('Accounting'), 'url' => route('admin.workspaces.accounting')], ['label' => __('Invoices')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Customer invoices'),'description' => __('Draft, approve, and post invoices to accounts receivable.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Customer invoices')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Draft, approve, and post invoices to accounts receivable.'))]); ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Sales\CustomerInvoice::class)): ?>
             <?php $__env->slot('actions', null, []); ?> 
                <a href="<?php echo e(route('admin.invoices.create')); ?>" class="erp-btn-primary" data-turbo-frame="erp-main" data-turbo-action="advance">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['searchPlaceholder' => __('Search invoices…'),'exportRoute' => 'admin.accounting.exports','exportRouteParams' => ['listing' => 'customer-invoices'],'exportQuery' => request()->query(),'formatInPath' => true,'exportFilename' => 'customer-invoices']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['search-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search invoices…')),'export-route' => 'admin.accounting.exports','export-route-params' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['listing' => 'customer-invoices']),'export-query' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->query()),'format-in-path' => true,'export-filename' => 'customer-invoices']); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr x-show="rowVisible(<?php echo \Illuminate\Support\Js::from(strtolower($invoice->invoice_number.' '.($invoice->customer?->company_name ?? '').' '.$invoice->status->value))->toHtml() ?>)">
                    <td>
                        <a href="<?php echo e(route('admin.invoices.show', $invoice)); ?>" class="font-mono text-sm text-erp-accent" data-turbo-frame="erp-main" data-turbo-action="advance"><?php echo e($invoice->invoice_number); ?></a>
                    </td>
                    <td class="text-sm"><?php echo e($invoice->customer?->company_name); ?></td>
                    <td class="text-sm"><?php echo e($invoice->invoice_date->format('Y-m-d')); ?></td>
                    <td class="text-sm"><?php echo e($invoice->invoice_type->label()); ?></td>
                    <td class="text-sm font-mono"><?php echo e(number_format($invoice->total_amount, 2)); ?></td>
                    <td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.invoices.show', $invoice)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.invoices.show', $invoice))]); ?><?php echo e(__('View')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'receipt-tax','title' => __('No invoices yet'),'description' => __('Create an invoice from a confirmed sales order with a remaining billable balance.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'receipt-tax','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No invoices yet')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Create an invoice from a confirmed sales order with a remaining billable balance.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\sales\invoices\index.blade.php ENDPATH**/ ?>