...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.index-toolbar','data' => ['action' => $hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'transfers'])),'resetUrl' => $hubUrl . '?tab=transfers']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'transfers']))),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUrl . '?tab=transfers')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['searchPlaceholder' => __('Search transfers…'),'exportFilename' => 'asset-transfers']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['search-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search transfers…')),'export-filename' => 'asset-transfers']); ?>
     <?php $__env->slot('head', null, []); ?> 
        <tr>
            <th scope="col"><?php echo e(__('Transfer no')); ?></th>
            <th scope="col"><?php echo e(__('Asset')); ?></th>
            <th scope="col"><?php echo e(__('From branch')); ?></th>
            <th scope="col"><?php echo e(__('To branch')); ?></th>
     ...
     <?php $__env->slot('body', null, []); ?> 
        <?php $__empty_1 = true; $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr x-show="rowVisible(<?php echo \Illuminate\Support\Js::from($search)->toHtml() ?>)">
                <td class="font-mono font-medium"><?php echo e($transfer->transfer_no); ?></td>
                <td><?php echo e($transfer->asset?->asset_name); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.status-badge','data' => ['variant' => $transfer->status->badgeVariant()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($transfer->status->badgeVariant())]); ?><?php echo e($transfer->status->label()); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></td>
                <td class="whitespace-nowrap"><?php echo e($transfer->requested_at?->format('Y-m-d H:i')); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.assets.custody.transfers.show', $transfer)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.assets.custody.transfers.show', $transfer))]); ?><?php echo e(__('View')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'truck','title' => __('No transfers yet'),'description' => __('Create a branch transfer to move an asset between locations.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'truck','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No transfers yet')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Create a branch transfer to move an asset between locations.'))]); ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Assets\AssetBranchTransfer::class)): ?>
                             <?php $__env->slot('action', null, []); ?> 
                                <a href="<?php echo e(route('admin.assets.custody.transfers.create')); ?>" class="erp-btn-primary" data-erp-modal-open><?php echo e(__('New transfer')); ?></a>
                             <?php $__env->endSlot(); ?>
                        <?php endif; ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\custody\partials\tabs\transfers.blade.php ENDPATH**/ ?>