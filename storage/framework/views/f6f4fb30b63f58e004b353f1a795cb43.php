...
<?php else: ?>
    <div class="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-sm font-semibold text-erp-primary"><?php echo e($registerTitle ?? __('Purchase Orders')); ?></h2>
        </div>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Procurement\PurchaseOrder::class)): ?>
            <a href="<?php echo e(route('admin.procurement.orders.create')); ?>" class="erp-btn-primary text-sm"><?php echo e(__('Create order')); ?></a>
        <?php endif; ?>
    </div>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\procurement\orders\partials\register-content.blade.php ENDPATH**/ ?>