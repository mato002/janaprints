...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'truck','title' => __('Procurement Reports'),'description' => $tab_data['message'] ?? __('No data available.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'truck','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Procurement Reports')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tab_data['message'] ?? __('No data available.'))]); ?>
...
<?php $component->withAttributes(['class' => 'mb-6']); ?>
        <h2 class="mb-4 text-sm font-semibold text-erp-primary"><?php echo e(__('Purchase Summary')); ?></h2>
        <div class="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
            ...
            <div>
                <p class="text-[11px] uppercase tracking-wide text-slate-500"><?php echo e(__('Spend')); ?></p>
                <p class="text-xl font-bold tabular-nums text-erp-primary"><?php echo e('KES '.number_format($tab_data['metrics']['spend'] ?? 0, 0)); ?></p>
            </div>
            <div>
            ...
            <div>
                <p class="text-[11px] uppercase tracking-wide text-slate-500"><?php echo e(__('Active Suppliers')); ?></p>
                <p class="text-xl font-bold tabular-nums text-erp-primary"><?php echo e(number_format($tab_data['metrics']['suppliers'] ?? 0)); ?></p>
            </div>
        </div>

        <?php echo $__env->make('admin.procurement.reports.partials.simple-table', [
...
<?php elseif(($tab_data['type'] ?? '') === 'trends'): ?>
    <?php echo $__env->make('admin.procurement.reports.partials.trends-charts', ['series' => $tab_data['series'] ?? []], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php elseif(($tab_data['type'] ?? '') === 'top_suppliers'): ?>
    <?php if (isset($component)) { $__componentOriginalad5130b5347ab6ecc017d2f5a278b926 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalad5130b5347ab6ecc017d2f5a278b926 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.card','data' => ['class' => 'mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.card'); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-6']); ?>
        <form method="GET" action="<?php echo e(route('admin.procurement.reports.index')); ?>" x-data="erpIndexFilterForm()" @change="onFieldChange($event)" class="mb-4 flex flex-wrap items-center gap-2" data-turbo-frame="erp-main">
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/procurement/reports/partials/tab-content.blade.php ENDPATH**/ ?>