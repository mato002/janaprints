...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Training Assignments'),'breadcrumbs' => [['label' => __('HR'), 'url' => route('admin.workspaces.hr')], ['label' => __('Training'), 'url' => route('admin.hr.training.dashboard')], ['label' => __('Assignments')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Training Assignments')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Training Assignments'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['exportFilename' => 'training-assignments']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['export-filename' => 'training-assignments']); ?>
         <?php $__env->slot('head', null, []); ?> 
            <tr>
                ...
                <th><?php echo e(__('Certificate Expiry')); ?></th>
            </tr>
         <?php $__env->endSlot(); ?>
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td>
                        <a href="<?php echo e(route('admin.hr.training.assignments.show', $assignment)); ?>" class="font-medium text-indigo-600 hover:underline"><?php echo e($assignment->reference); ?></a>
                    </td>
                    <td><?php echo e($assignment->employee->full_name); ?></td>
                    <td><?php echo e($assignment->program->title); ?></td>
                    <td><?php echo e($assignment->program->type->label()); ?></td>
                    <td><?php echo e(number_format($assignment->hours_completed, 1)); ?></td>
                    <td><?php echo e($assignment->status->label()); ?></td>
                    <td>
                        <?php if($assignment->certificate_expires_at): ?>
                            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-rose-600' => $assignment->isCertificateExpired(), 'text-amber-600' => $assignment->isCertificateExpiringSoon()]); ?>">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="7" class="py-6 text-center text-slate-500"><?php echo e(__('No assignments found.')); ?></td></tr>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\training\assignments\index.blade.php ENDPATH**/ ?>