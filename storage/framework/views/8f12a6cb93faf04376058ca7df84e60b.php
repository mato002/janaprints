...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Create Document Type'),'breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
        <form method="POST" action="<?php echo e(route('admin.settings.document-types.store')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="mt-8 flex justify-end gap-3">
                ...
                <button type="submit" class="erp-btn erp-btn--primary"><?php echo e(__('Create Document Type')); ?></button>
            </div>
        </form>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\settings\document-types\create.blade.php ENDPATH**/ ?>