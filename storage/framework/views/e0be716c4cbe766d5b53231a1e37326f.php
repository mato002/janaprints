...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Artwork'),'breadcrumbs' => [['label' => __('Artwork')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Artwork'),'description' => __('Design requests, versions, and approvals.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Artwork')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Design requests, versions, and approvals.'))]); ?>
...
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([])]); ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Artwork\ArtworkRequest::class)): ?>
                <a href="<?php echo e(route('admin.artwork.create')); ?>" class="erp-btn-primary"><?php echo e(__('New request')); ?></a>
            <?php endif; ?>
            <a href="<?php echo e(route('admin.artwork.index')); ?>" class="erp-btn-secondary"><?php echo e(__('All requests')); ?></a>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/artwork/dashboard.blade.php ENDPATH**/ ?>