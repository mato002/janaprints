...
<?php $component->withAttributes([]); ?>
    <?php echo $__env->make('admin.website.partials.role-guidance', ['context' => 'settings'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($description)]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <span class="text-xs text-slate-500"><?php echo e(__('Values fall back to config until saved in CMS.')); ?></span>
         <?php $__env->endSlot(); ?>
...
<?php $component->withAttributes([]); ?>
        <form
            ...
            <?php if($useTabs): ?> data-settings-tabs <?php endif; ?>
        ...
        >
                    ...
                    >
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                            <?php $__currentLoopData = $schema; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php echo $__env->make('admin.website.settings.field', [
                                    'key' => $key,
                                    'meta' => $meta,
            ...
            <?php else: ?>
                <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <section class="mb-8">
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                            <?php $__currentLoopData = $schema; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($meta['group'] !== $group) continue; ?>
                                <?php echo $__env->make('admin.website.settings.field', [
                                    'key' => $key,
                                    'meta' => $meta,
                                    'record' => $records->get($key),
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', App\Models\WebsiteSetting::class)): ?>
                <div class="mt-8 flex flex-wrap gap-3 border-t border-slate-200 pt-5">
                    ...
                    <a
                        href="<?php echo e(WorkspaceEmbed::url(route('admin.workspaces.administration.section', 'website-content'))); ?>"
                        class="erp-btn-secondary"
                        data-turbo-frame="<?php echo e(WorkspaceEmbed::turboFrame()); ?>"
                    ><?php echo e(__('Back to Website Content')); ?></a>
                </div>
            <?php endif; ?>
        </form>
     <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/website/settings/form.blade.php ENDPATH**/ ?>