...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.lookup-select','data' => ['name' => 'inventory_category_id','label' => __('Category'),'options' => $categories,'value' => old('inventory_category_id', $m?->inventory_category_id),'required' => true,'createRoute' => 'admin.inventory.catalogue.categories.quick-create','refreshRoute' => 'admin.lookups.categories','permission' => 'catalogue.create','modalTitle' => __('Create category'),'optionLabelKey' => 'name','optionValueKey' => 'id','selectClass' => 'erp-select w-full','emptyOption' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
