<div class="grid gap-4 sm:grid-cols-2">
    <div>
        <label class="erp-label" for="template-code"><?php echo e(__('Code')); ?></label>
        <input type="text" id="template-code" name="code" class="erp-input w-full" value="<?php echo e(old('code', $template?->code)); ?>" required>
    </div>
    <div>
