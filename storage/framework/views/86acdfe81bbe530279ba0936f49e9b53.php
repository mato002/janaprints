...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Leave Balances'),'breadcrumbs' => [['label' => __('Leave'), 'url' => route('admin.hr.leave.dashboard')], ['label' => __('Balances')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Leave Balances'),'description' => __('Opening balance, earned, taken, pending, and available leave.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Leave Balances')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Opening balance, earned, taken, pending, and available leave.'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('admin.hr.leave.dashboard')); ?>" class="erp-btn-secondary"><?php echo e(__('Dashboard')); ?></a>
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\leave\balances.blade.php ENDPATH**/ ?>