...
<?php
    $value = $type instanceof \App\Enums\ActivityType ? $type->value : (string) $type;
    $tone = match ($value) {
        'call' => 'call',
        'meeting' => 'meeting',
        'email' => 'email',
...
<span <?php echo e($attributes->merge(['class' => 'activity-show__type-icon activity-show__type-icon--' . $tone])); ?> aria-hidden="true">
    <?php switch($value):
        case ('call'): ?>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\commercial\activities\partials\type-icon.blade.php ENDPATH**/ ?>