...
<?php endif; ?>
            <input
                ...
                placeholder="<?php echo e(__('Search administration workspaces…')); ?>"
            ...
            <p
                ...
                x-text="visibleCount === 1 ? '<?php echo e(__('1 workspace matches')); ?>' : `<?php echo e(__(':count workspaces match')); ?>`.replace(':count', visibleCount)`"
            ></p>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\administration\workspaces\hub.blade.php ENDPATH**/ ?>