<p class="mb-3 text-sm text-slate-600"><?php echo e(__('Jobs awaiting a quality inspection (not yet in the register).')); ?></p>
...
<?php $component->withAttributes(['searchable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'exportable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
     <?php $__env->slot('head', null, []); ?> 
        <tr>
            ...
            <th scope="col" class="hidden lg:table-cell"><?php echo e(__('Due Date')); ?></th>
            <th scope="col" class="hidden sm:table-cell"><?php echo e(__('Inspector')); ?></th>
            <th scope="col"><?php echo e(__('Status')); ?></th>
            <th scope="col" class="erp-table-actions-col"><?php echo e(__('Actions')); ?></th>
        </tr>
     <?php $__env->endSlot(); ?>
     <?php $__env->slot('body', null, []); ?> 
        <?php $__empty_1 = true; $__currentLoopData = $register; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php $row = $workspace->presentPendingRow($job); ?>
            <tr>
                ...
                <td class="hidden tabular-nums lg:table-cell"><?php echo e($row['due_date']); ?></td>
                <td class="hidden text-slate-400 sm:table-cell"><?php echo e($row['inspector_name']); ?></td>
                <td><span class="erp-badge bg-amber-100 text-amber-900"><?php echo e($row['status_label']); ?></span></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'badge-check','title' => __('No pending inspections'),'description' => __('All jobs have moved past the QC stage or none are queued for inspection.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'badge-check','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No pending inspections')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('All jobs have moved past the QC stage or none are queued for inspection.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\production\quality\partials\register-pending.blade.php ENDPATH**/ ?>