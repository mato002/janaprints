...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['filters', 'branches', 'salespersons', 'report_options' => null, 'report_key' => null, 'filter_action' => null, 'filter_reset_url' => null]));
...
foreach (array_filter((['filters', 'branches', 'salespersons', 'report_options' => null, 'report_key' => null, 'filter_action' => null, 'filter_reset_url' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php
    ...
    $toolbarAction = $filter_action ?? route('admin.commercial.reports.customers.index');
    $toolbarResetUrl = $filter_reset_url ?? route('admin.commercial.reports.customers.index');
?>
