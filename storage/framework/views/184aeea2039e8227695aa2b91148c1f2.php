...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => $section === 'hub' ? __('System Settings') : $sectionMeta['label'],'breadcrumbs' => $embedded ? [] : [
...
<?php $component->withAttributes([]); ?>
    <?php if($section === 'hub'): ?>
        <?php echo $__env->make('admin.settings.partials.hub-control-center', [
...
<?php $component->withAttributes([]); ?>
            <?php if($canManage): ?>
                <form method="POST" action="<?php echo e(route('admin.settings.update', $section)); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php echo $__env->make('admin.settings.partials.settings-table', ['editable' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
            ...
            <?php else: ?>
                <?php echo $__env->make('admin.settings.partials.settings-table', ['editable' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\settings\show.blade.php ENDPATH**/ ?>