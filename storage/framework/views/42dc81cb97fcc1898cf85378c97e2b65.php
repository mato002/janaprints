...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Machines'),'description' => __('Production-capable machine assets.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Machines')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Production-capable machine assets.'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', \App\Models\Assets\MachineProfile::class)): ?>
                <a href="<?php echo e(route('admin.assets.machines.dashboard')); ?>" class="erp-btn-secondary"><?php echo e(__('Machine Dashboard')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
            ...
            <table class="erp-table w-full text-sm">
                <thead>
                    <tr>
                        ...
                        <th class="text-right"><?php echo e(__('Utilization')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <a href="<?php echo e(route('admin.assets.machines.show', $profile->asset)); ?>" class="erp-link font-medium">
                                    <?php echo e($profile->asset?->asset_name); ?>

                                </a>
                                <p class="text-xs text-slate-500"><?php echo e($profile->asset?->asset_number); ?></p>
                            </td>
                            <td class="font-mono"><?php echo e($profile->machine_code); ?></td>
...
<?php endif; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="6" class="py-8 text-center text-slate-500"><?php echo e(__('No production machines yet. Activate a machine profile from the asset register.')); ?></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
        <?php if($machines->hasPages()): ?>
