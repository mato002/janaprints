...
<?php elseif(($action['type'] ?? '') === 'panel'): ?>
    ...
    <?php else: ?>
        <button type="button" class="<?php echo e($buttonClass); ?>" @click="openActionModal(<?php echo \Illuminate\Support\Js::from($jobKey)->toHtml() ?>, 'machine')"><?php echo e($action['label']); ?></button>
    <?php endif; ?>
<?php else: ?>
    <?php
        $linkUrl = $action['url'];
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/production/floor/partials/next-step-action.blade.php ENDPATH**/ ?>