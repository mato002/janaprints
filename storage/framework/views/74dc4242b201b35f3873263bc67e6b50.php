...
<?php
    $icons = [
        ...
        'university' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-5-9-5-9 5 9 5z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 14v7"/>',
        ...
        'hospital' => '<path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 11v4m-2-2h4"/>',
        'retail' => '<path stroke-linecap="round" stroke-linejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>',
    ];
?>

<div <?php echo e($attributes->merge(['class' => 'public-trust-category'])); ?>>
    <div class="public-trust-category__icon">
        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            <?php echo $icons[$icon] ?? $icons['building']; ?>

        </svg>
    </div>
    <span class="public-trust-category__label"><?php echo e($category); ?></span>
</div>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/components/public/trust-category.blade.php ENDPATH**/ ?>