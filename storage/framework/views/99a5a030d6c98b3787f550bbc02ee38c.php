...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Capitalization Workbench'),'breadcrumbs' => [['label' => __('Capitalization Queue'), 'url' => route('admin.assets.acquisitions.queue')], ['label' => $candidate->candidate_number]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['class' => 'lg:col-span-2']); ?>
            <form method="POST" action="<?php echo e(route('admin.assets.acquisitions.capitalize', $candidate)); ?>" class="space-y-4">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.assets.acquisitions.queue')); ?>" class="erp-btn-secondary"><?php echo e(__('Back')); ?></a>
                </div>
            </form>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
