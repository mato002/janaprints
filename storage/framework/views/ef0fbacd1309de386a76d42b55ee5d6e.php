...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Quotations'),'breadcrumbs' => [['label' => __('Sales')], ['label' => __('Quotations')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Quotations'),'description' => __('Quotation pipeline and conversion metrics.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Quotations')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Quotation pipeline and conversion metrics.'))]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.quotations.create'))]); ?><?php echo e(__('New quotation')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <?php endif; ?>
            <a href="<?php echo e(route('admin.quotations.index')); ?>" class="erp-btn-secondary"><?php echo e(__('All quotations')); ?></a>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/sales/quotations/dashboard.blade.php ENDPATH**/ ?>