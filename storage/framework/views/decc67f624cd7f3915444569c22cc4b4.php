...
<article
    ...
    data-journey-step="<?php echo e($step['number']); ?>"
    data-animate="fade-up"
    data-animate-delay="<?php echo e(min($step['number'], 5)); ?>"
>
    <div class="public-journey-step__body">
        <div class="public-journey-step__header">
            <span class="public-journey-step__number" aria-hidden="true"><?php echo e($step['number']); ?></span>
            <div class="public-journey-step__icon" aria-hidden="true">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
                    <?php echo $icons[$step['icon']] ?? $icons['document']; ?>
        ...
        <h3 class="public-journey-step__title"><?php echo e($step['title']); ?></h3>
        <p class="public-journey-step__desc"><?php echo e($step['description']); ?></p>

        <?php if(! empty($step['trust'])): ?>
            <p class="public-journey-step__trust-label"><?php echo e($step['trust']); ?></p>
        <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.media-image','data' => ['src' => $step['image'],'alt' => $step['alt'],'fallback' => 'print_press','class' => 'h-full w-full object-cover','width' => '400','height' => '240']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['src' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($step['image']),'alt' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($step['alt']),'fallback' => 'print_press','class' => 'h-full w-full object-cover','width' => '400','height' => '240']); ?>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\public\journey-step.blade.php ENDPATH**/ ?>