...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
        ...
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <?php $__currentLoopData = $warehouseSnapshot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($warehouse['url']); ?>" class="block rounded-lg border border-erp-border bg-white p-3 transition hover:border-erp-accent/40 hover:bg-slate-50" data-turbo-frame="_top">
