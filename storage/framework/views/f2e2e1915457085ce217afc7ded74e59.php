...
<?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $customer)): ?>
            <form method="POST" action="<?php echo e(route('admin.crm.customers.files.store', $customer)); ?>" enctype="multipart/form-data" data-turbo-frame="_top" class="crm-360__upload-form mt-4">
                <?php echo csrf_field(); ?>
