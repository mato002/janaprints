...
<?php $component->withAttributes(['class' => 'mb-6']); ?>
    <div class="mb-3 flex items-center justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-xs text-slate-500"><?php echo e(__('Operational sources required before sales order reports can run.')); ?></p>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\commercial\reports\sales-orders\partials\readiness-table.blade.php ENDPATH**/ ?>