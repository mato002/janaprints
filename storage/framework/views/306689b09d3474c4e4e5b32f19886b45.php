...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Search communications'),'breadcrumbs' => [['label' => __('Communication Logs'), 'url' => route('admin.communications.logs.dashboard')], ['label' => __('Search')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Global communication search')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Global communication search'))]); ?>
...
<?php endif; ?>
    ...
    <form method="GET" class="erp-card mb-4 flex gap-2" data-turbo-frame="erp-main">
        <input type="search" name="q" value="<?php echo e($filters['q'] ?? ''); ?>" class="erp-input flex-1" placeholder="<?php echo e(__('Phone, email, template, reference, recipient…')); ?>" autofocus>
        <button type="submit" class="erp-btn erp-btn--primary"><?php echo e(__('Search')); ?></button>
    </form>
...
<?php endif; ?>
        <?php if($logs->hasPages()): ?><div class="mt-4"><?php echo e($logs->links()); ?></div><?php endif; ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\communications\logs\search.blade.php ENDPATH**/ ?>