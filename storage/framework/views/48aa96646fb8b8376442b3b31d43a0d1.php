<?php
    $tabFilters = collect(request()->query())
        ->except(['tab'])
        ->all();
?>
...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
    <nav class="flex flex-wrap gap-2" aria-label="<?php echo e(__('Maintenance sections')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\maintenance\partials\tabs-nav.blade.php ENDPATH**/ ?>