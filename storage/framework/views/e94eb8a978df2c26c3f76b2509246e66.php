...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => $fromStoreDesk
                                ...
                                : route('admin.inventory.receipts.show', $r),'dataErpModalOpen' => $fromStoreDesk ? true : null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($fromStoreDesk
                                ? route('admin.inventory.receipts.show', [$r, 'from' => 'store-desk'])
                                : route('admin.inventory.receipts.show', $r)),'data-erp-modal-open' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($fromStoreDesk ? true : null)]); ?><?php echo e(__('View')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/inventory/receipts/partials/table.blade.php ENDPATH**/ ?>