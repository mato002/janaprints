...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Dead Stock'),'breadcrumbs' => [
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Dead Stock'),'description' => __('Stock with balance and no outbound movement for :days+ days.', ['days' => config('inventory_intelligence.dead_stock_days')])]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Dead Stock')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Stock with balance and no outbound movement for :days+ days.', ['days' => config('inventory_intelligence.dead_stock_days')]))]); ?>
...
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url()->current()),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url()->current())]); ?>
            ...
            <select name="stock_role" class="erp-toolbar-select" aria-label="<?php echo e(__('Stock role')); ?>">
                <option value=""><?php echo e(__('All stock roles')); ?></option>
                <?php $__currentLoopData = \App\Enums\InventoryStockRole::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($role->value); ?>" <?php if(($filters['stock_role'] ?? '') === $role->value): echo 'selected'; endif; ?>><?php echo e($role->label()); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\inventory\intelligence\dead-stock.blade.php ENDPATH**/ ?>