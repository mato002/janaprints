...
<?php $component->withAttributes([]); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $payslips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payslip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><?php echo e($payslip->payrollRun?->reference ?? $payslip->reference); ?></td>
                    <td>
                        <?php echo e($payslip->payrollRun?->period_start?->format('M j')); ?>

                        –
                        <?php echo e($payslip->payrollRun?->period_end?->format('M j, Y')); ?>

                    </td>
                    <td><?php echo e(number_format($payslip->gross_pay, 2)); ?></td>
                    <td><?php echo e(number_format($payslip->net_pay, 2)); ?></td>
                    <td class="erp-table-actions-col">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', $payslip->payrollRun)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.hr.payroll.payslip.download', $payslip)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.payroll.payslip.download', $payslip))]); ?><?php echo e(__('PDF')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['title' => __('No payslips yet')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No payslips yet'))]); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/employees/tabs/payroll-history.blade.php ENDPATH**/ ?>