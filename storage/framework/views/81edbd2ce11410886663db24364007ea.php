...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => $workOrder->work_order_no,'breadcrumbs' => [['label' => __('Assets'), 'url' => route('admin.workspaces.assets')], ['label' => __('Maintenance'), 'url' => route('admin.assets.maintenance.dashboard', ['tab' => 'work-orders'])], ['label' => $workOrder->work_order_no]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
