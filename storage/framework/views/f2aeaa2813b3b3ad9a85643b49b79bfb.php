...
<?php else: ?>
    <div class="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-sm font-semibold text-erp-primary"><?php echo e($registerTitle ?? __('Vendors')); ?></h2>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\procurement\vendors\partials\register-content.blade.php ENDPATH**/ ?>