...
>
    <div class="flex h-full w-full max-w-xl flex-col bg-white shadow-xl">
        <div class="flex items-center justify-between border-b border-erp-border px-5 py-4">
            <div>
                <h2 class="text-lg font-semibold text-erp-primary"><?php echo e(__('Email detail')); ?></h2>
            ...
            <template x-if="!loading && detail">
                <div class="space-y-4 text-sm">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Status')); ?></p>
                            <p class="mt-1 font-medium" x-text="detail.status_label"></p>
                        </div>
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Retry count')); ?></p>
                            <p class="mt-1" x-text="detail.retry_count"></p>
                        </div>
                    </div>
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Sender')); ?></p>
                    ...
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Recipients')); ?></p>
                        <p class="mt-1" x-text="(detail.recipients?.to ?? []).map(r => r.email).join(', ')"></p>
                    </div>
                    <template x-if="detail.related_entity">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Related entity')); ?></p>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Created')); ?></p>
                            <p class="mt-1" x-text="detail.created_at_formatted ?? '—'"></p>
                        </div>
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Sent')); ?></p>
                            <p class="mt-1" x-text="detail.sent_at_formatted ?? '—'"></p>
                        </div>
                    </div>
                    <template x-if="detail.failed_at_formatted">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Failed')); ?></p>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Entity')); ?></p>
                    ...
                    <template x-if="detail.failure_reason">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Failure reason')); ?></p>
                            <p class="mt-1 text-red-600" x-text="detail.failure_reason"></p>
                        </div>
                    </template>
                    <template x-if="(detail.attachments ?? []).length">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Attachments')); ?></p>
                    ...
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-wide text-slate-500"><?php echo e(__('Audit timeline')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/communications/email/partials/detail-drawer.blade.php ENDPATH**/ ?>