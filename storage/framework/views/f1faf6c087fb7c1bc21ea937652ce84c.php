...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
    ...
    <?php if(($fields['code']['visible'] ?? true)): ?>
        <div>
            ...
            <input type="text" name="code" class="erp-input w-full" value="<?php echo e(old('code', $book?->code)); ?>" <?php if($fields['code']['required'] ?? true): echo 'required'; endif; ?> <?php if($fields['code']['read_only'] ?? false): echo 'readonly'; endif; ?>>
        </div>
    <?php endif; ?>
