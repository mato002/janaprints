<section class="crm-360__kpi-strip" aria-label="<?php echo e(__('Customer KPIs')); ?>">
    <?php $__currentLoopData = $kpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            ...
            $key = $kpi['key'] ?? 'default';
            $group = match ($key) {
                'revenue', 'balance' => 'financial',
                'conversations', 'complaints', 'activity' => 'engagement',
                'quotes', 'orders' => 'commercial',
                default => 'general',
            };
        ?>
        <article
            class="crm-360__kpi crm-360__kpi--<?php echo e($priority); ?> crm-360__kpi--<?php echo e($key); ?> crm-360__kpi-group--<?php echo e($group); ?>"
            data-kpi="<?php echo e($key); ?>"
        >
                ...
                <span class="crm-360__kpi-icon crm-360__kpi-icon--<?php echo e($kpi['icon'] ?? 'default'); ?>" aria-hidden="true">
                    <?php switch($kpi['icon'] ?? 'default'):
                        ...
                        <?php case ('balance'): ?>
                            ...
                            <?php break; ?>
                        <?php case ('chat'): ?>
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg>
                            <?php break; ?>
                        <?php case ('quote'): ?>
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            <?php break; ?>
                        <?php case ('order'): ?>
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                            <?php break; ?>
                        <?php case ('activity'): ?>
                            ...
                            <?php break; ?>
                        <?php default: ?>
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <?php endswitch; ?>
                </span>
                <?php if($trend === 'up'): ?>
...
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\360\kpi-strip.blade.php ENDPATH**/ ?>