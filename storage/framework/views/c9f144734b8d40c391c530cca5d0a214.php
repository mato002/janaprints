    ...
    <table class="min-w-full text-sm">
        ...
        <tbody class="divide-y divide-slate-100">
            <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="px-3 py-2"><a href="<?php echo e(route('admin.invoices.show', $invoice)); ?>" class="font-mono text-erp-accent"><?php echo e($invoice->invoice_number); ?></a></td>
                    <td class="px-3 py-2"><?php echo e($invoice->invoice_date->format('M j, Y')); ?></td>
                    ...
                    <td class="px-3 py-2 text-right font-mono"><?php echo e(number_format($invoice->balance_due, 2)); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.status-badge','data' => ['variant' => match($invoice->status->value) { 'posted' => 'success', 'approved' => 'info', 'cancelled' => 'warning', default => 'neutral' }]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(match($invoice->status->value) { 'posted' => 'success', 'approved' => 'info', 'cancelled' => 'warning', default => 'neutral' })]); ?><?php echo e($invoice->status->label()); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></td>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="6" class="px-3 py-6 text-center text-slate-500"><?php echo e(__('No invoices')); ?></td></tr>
            <?php endif; ?>
        </tbody>
    </table>
</div>
<?php if(empty($compact) && method_exists($invoices, 'links')): ?>
...
<?php endif; ?></div>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\360\partials\financial-invoices.blade.php ENDPATH**/ ?>