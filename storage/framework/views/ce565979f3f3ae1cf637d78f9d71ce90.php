...
<?php $component->withAttributes(['class' => 'border-emerald-200 bg-emerald-50/50']); ?>
        ...
        <?php if($production['department_queue_url'] ?? null): ?>
            <a href="<?php echo e($production['department_queue_url']); ?>" class="mt-3 inline-flex text-xs text-erp-primary hover:underline" data-turbo-frame="_top"><?php echo e(__('Open department register')); ?></a>
        <?php endif; ?>
