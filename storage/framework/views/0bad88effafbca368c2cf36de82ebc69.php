...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Pay runs'),'breadcrumbs' => [['label' => __('HR'), 'url' => route('admin.workspaces.hr')], ['label' => __('Pay runs')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Pay runs'),'description' => __('Run payroll for a period, generate payslips, and post to accounts. Set up employee salaries under the Salaries tab first.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Pay runs')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Run payroll for a period, generate payslips, and post to accounts. Set up employee salaries under the Salaries tab first.'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Hr\PayrollRun::class)): ?>
                <a href="<?php echo e(route('admin.hr.payroll.create')); ?>" class="erp-btn-primary" data-erp-modal-open><?php echo e(__('New payroll run')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.card','data' => ['class' => 'mt-6','padding' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-6','padding' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
        <div class="flex items-center justify-between border-b border-erp-border px-4 py-3">
            <h2 class="text-sm font-semibold text-erp-primary"><?php echo e(__('Recent payroll runs')); ?></h2>
            <a href="<?php echo e(route('admin.hr.payroll.index')); ?>" class="text-sm font-medium text-erp-accent hover:underline"><?php echo e(__('View all runs')); ?></a>
        </div>
...
<?php $component->withAttributes(['searchable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'exportable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
             <?php $__env->slot('head', null, []); ?> 
                <tr>
                    ...
                    <th class="hidden sm:table-cell"><?php echo e(__('Employees')); ?></th>
                    <th><?php echo e(__('Net pay')); ?></th>
             ...
             <?php $__env->slot('body', null, []); ?> 
                <?php $__empty_1 = true; $__currentLoopData = $recentRuns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $run): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="font-mono text-[11px]"><?php echo e($run->reference); ?></td>
                        <td class="text-sm"><?php echo e($run->period_start?->format('M j')); ?> – <?php echo e($run->period_end?->format('M j, Y')); ?></td>
                        <td><?php echo e($run->pay_date?->format('M j, Y')); ?></td>
                        <td class="hidden sm:table-cell tabular-nums"><?php echo e($run->employee_count); ?></td>
                        <td class="tabular-nums font-medium"><?php echo e(number_format($run->net_total, 2)); ?></td>
                        <td><span class="erp-badge erp-badge--<?php echo e($run->status?->badgeClass()); ?>"><?php echo e($run->status?->label()); ?></span></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.hr.payroll.show', $run)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.payroll.show', $run))]); ?><?php echo e(__('Open')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'cash','title' => __('No payroll runs yet'),'description' => __('Start a new payroll run when salaries are set up and the pay period is ready.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'cash','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No payroll runs yet')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Start a new payroll run when salaries are set up and the pay period is ready.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/hr/payroll/dashboard.blade.php ENDPATH**/ ?>