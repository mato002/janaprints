...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['exportListing' => null]));
...
foreach (array_filter((['exportListing' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url()->current()),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url()->current())]); ?>
        <select name="tax_period_id" class="erp-toolbar-select" aria-label="<?php echo e(__('Tax period')); ?>">
            <option value=""><?php echo e(__('Custom range')); ?></option>
            <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($period->id); ?>" <?php if(($filters['tax_period_id'] ?? null) == $period->id): echo 'selected'; endif; ?>>
                    <?php echo e($period->code); ?> (<?php echo e($period->start_date->format('Y-m-d')); ?> – <?php echo e($period->end_date->format('Y-m-d')); ?>)
                </option>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\tax\partials\report-filters.blade.php ENDPATH**/ ?>