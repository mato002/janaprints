...
<?php if($can_view_categories ?? false): ?>
    <?php if (isset($component)) { $__componentOriginalad5130b5347ab6ecc017d2f5a278b926 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalad5130b5347ab6ecc017d2f5a278b926 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.card','data' => ['id' => 'asset-categories','class' => 'mb-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'asset-categories','class' => 'mb-4']); ?>
        <div class="mb-3 flex flex-wrap items-center justify-between gap-2">
            <div>
                <h2 class="text-sm font-semibold"><?php echo e(__('Asset Categories')); ?></h2>
                <p class="text-xs text-slate-500"><?php echo e(__('Classification, useful life, and depreciation policies.')); ?></p>
            </div>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Assets\AssetCategory::class)): ?>
                <a href="<?php echo e(WorkspaceEmbed::url(route('admin.assets.categories.create'))); ?>" class="erp-btn-secondary erp-btn--sm" data-erp-modal-open><?php echo e(__('New category')); ?></a>
            <?php endif; ?>
        </div>
            ...
            <table class="erp-table w-full text-sm">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(__('Useful life')); ?></th>
                        <th><?php echo e(__('Assets')); ?></th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="font-medium">
                                <a
                                    href="<?php echo e(WorkspaceEmbed::url(route('admin.assets.index', WorkspaceEmbed::queryParams(['category_id' => $category->id])))); ?>"
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\assets\partials\management-categories.blade.php ENDPATH**/ ?>