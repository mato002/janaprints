...
<label <?php echo e($attributes->merge(['class' => 'block text-sm font-medium text-erp-primary'.($required ? ' required' : '')])); ?>>
    <?php echo e($value ?? $slot); ?>

</label>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\input-label.blade.php ENDPATH**/ ?>