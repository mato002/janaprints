...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($request->request_number),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($request->customer?->company_name)]); ?>
        <?php if($designerOperator): ?>
            <a href="<?php echo e(route('admin.artwork.desk')); ?>" class="erp-btn-secondary" data-turbo-frame="_top"><?php echo e(__('Back to Designer Desk')); ?></a>
        <?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', [App\Models\Artwork\ArtworkVersion::class, $request])): ?>
                <form method="POST" action="<?php echo e(route('admin.artwork.versions.store', $request)); ?>" enctype="multipart/form-data" data-turbo-frame="_top" class="mt-4 space-y-2">
                    <?php echo csrf_field(); ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $request)): ?>
                <form method="POST" action="<?php echo e(route('admin.artwork.files.store', $request)); ?>" enctype="multipart/form-data" data-turbo-frame="_top" class="mt-4">
                    <?php echo csrf_field(); ?>
