...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Applications')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Applications')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Applications'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Hr\JobApplication::class)): ?>
                <a href="<?php echo e(route('admin.hr.recruitment.applications.create')); ?>" class="erp-btn-primary"><?php echo e(__('New application')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><a href="<?php echo e(route('admin.hr.recruitment.applications.show', $application)); ?>" class="font-medium text-erp-primary hover:underline"><?php echo e($application->candidate->full_name); ?></a></td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\hr\recruitment\applications\index.blade.php ENDPATH**/ ?>