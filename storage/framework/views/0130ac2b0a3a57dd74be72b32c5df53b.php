    ...
    <table class="min-w-full text-sm">
        <thead class="bg-slate-50">
            <tr>
                ...
                <th class="px-3 py-2 text-right"><?php echo e(__('Allocated')); ?></th>
        ...
        <tbody class="divide-y divide-slate-100">
            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="px-3 py-2 text-right font-mono"><?php echo e(number_format($payment->allocated_amount, 2)); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.status-badge','data' => ['variant' => $payment->status->value === 'posted' ? 'success' : 'neutral']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($payment->status->value === 'posted' ? 'success' : 'neutral')]); ?><?php echo e($payment->status->label()); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></td>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="5" class="px-3 py-6 text-center text-slate-500"><?php echo e(__('No payments')); ?></td></tr>
            <?php endif; ?>
        </tbody>
    </table>
</div>
<?php if(empty($compact) && method_exists($payments, 'links')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-pagination','data' => ['paginator' => $payments]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?></div>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\admin\crm\customers\360\partials\financial-payments.blade.php ENDPATH**/ ?>