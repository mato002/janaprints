...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Leave Requests'),'breadcrumbs' => [['label' => __('HR'), 'url' => route('admin.workspaces.hr')], ['label' => __('Leave'), 'url' => route('admin.hr.leave.dashboard')], ['label' => __('Requests')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => __('Leave Requests')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Leave Requests'))]); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('admin.hr.leave.dashboard')); ?>" data-turbo-frame="erp-main" class="erp-btn-secondary"><?php echo e(__('Dashboard')); ?></a>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Hr\LeaveRequest::class)): ?>
                <a href="<?php echo e(route('admin.hr.leave.create')); ?>" class="erp-btn-primary" data-erp-modal-open><?php echo e(__('Apply for leave')); ?></a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.leave.index')),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.leave.index')),'compact' => true,'class' => 'erp-index-toolbar-form--compact']); ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export', App\Models\Hr\LeaveRequest::class)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.export-dropdown','data' => ['postAction' => route('admin.hr.leave.export'),'postFields' => $filters]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['post-action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.leave.export')),'post-fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($filters)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <select name="leave_type_id" class="erp-toolbar-select" aria-label="<?php echo e(__('Leave Type')); ?>">
                ...
                <?php $__currentLoopData = $formData['leaveTypes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($type->id); ?>" <?php if((int) ($filters['leave_type_id'] ?? 0) === $type->id): echo 'selected'; endif; ?>><?php echo e($type->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.data-table','data' => ['searchPlaceholder' => __('Search leave requests…'),'exportable' => false,'exportFilename' => 'leave-requests']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['search-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search leave requests…')),'exportable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'export-filename' => 'leave-requests']); ?>
         ...
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr x-show="rowVisible(<?php echo \Illuminate\Support\Js::from(strtolower(implode(' ', [$leaveRequest->reference, $leaveRequest->employee?->full_name, $leaveRequest->leaveType?->name])))->toHtml() ?>)">
                    <td class="font-mono text-[11px]"><?php echo e($leaveRequest->reference ?? '—'); ?></td>
                    <td class="font-medium"><?php echo e($leaveRequest->employee?->full_name); ?></td>
                    <td><?php echo e($leaveRequest->leaveType?->name); ?></td>
                    <td class="text-sm"><?php echo e($leaveRequest->start_date?->format('M j')); ?> – <?php echo e($leaveRequest->end_date?->format('M j, Y')); ?></td>
                    <td class="tabular-nums"><?php echo e($leaveRequest->days_requested); ?></td>
                    <td>
                        <span class="erp-badge erp-badge--<?php echo e($leaveRequest->status?->badgeClass()); ?>"><?php echo e($leaveRequest->status?->label()); ?></span>
                    </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-row-action','data' => ['href' => route('admin.hr.leave.show', $leaveRequest)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hr.leave.show', $leaveRequest))]); ?><?php echo e(__('View')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['icon' => 'calendar','title' => __('No leave requests')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'calendar','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No leave requests'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/hr/leave/index.blade.php ENDPATH**/ ?>