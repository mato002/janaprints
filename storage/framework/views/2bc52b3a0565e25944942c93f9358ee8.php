...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => __('Buy Desk'),'breadcrumbs' => [
...
<?php $component->withAttributes([]); ?>
    <div class="buy-desk-command store-desk-command">
        <?php if (! (\App\Support\Navigation\WorkspaceEmbed::inWorkspaceContext())): ?>
            <?php echo $__env->make('admin.procurement.partials.desk-mode-nav', ['activeProcurementView' => \App\Support\Procurement\ProcurementDeskViews::DESK], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
