...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['tabs' => [], 'activeTab' => 'overview', 'filters' => []]));
...
foreach (array_filter((['tabs' => [], 'activeTab' => 'overview', 'filters' => []]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
    <nav class="flex flex-wrap gap-2">
        <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(request()->url()); ?>?<?php echo e(http_build_query(array_merge($filters ?? [], ['tab' => $key]))); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views/admin/printing-intelligence/partials/workspace-tabs.blade.php ENDPATH**/ ?>