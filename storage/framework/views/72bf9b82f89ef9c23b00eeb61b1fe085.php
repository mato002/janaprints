...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.compact-workspace-header','data' => ['title' => $title,'description' => $description,'attributes' => $attributes->except(['title', 'description'])]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jana-prints\resources\views\components\admin\workspace-header.blade.php ENDPATH**/ ?>