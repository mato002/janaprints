...
<x-admin.card :hover="true" class="relative overflow-hidden">
    <div class="flex items-start justify-between gap-3">
        <div class="min-w-0">
            ...
            <p class="mt-2 text-card-value text-erp-primary tabular-nums">{{ $value }}</p>
            @if ($hint)
        ...
        @if ($icon)
            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-erp-accent/10 text-erp-accent">
