...
<section id="get-started" class="public-final-cta" data-reveal-section aria-label="Start your next print project">
    ...
    <div class="public-container public-section relative">
        <div class="public-final-cta__content" data-animate="fade-up">
            <h2 class="public-final-cta__title">{{ $finalCta['title'] }}</h2>
            <p class="public-final-cta__subtitle">{{ $finalCta['subtitle'] }}</p>
            ...
            <p class="public-final-cta__secondary">
                <a href="{{ $contactSectionHref }}" class="public-final-cta__link">Contact Us</a>
            </p>
        </div>
    </div>
</section>
