        ...
        <div class="grid gap-10 lg:grid-cols-12 lg:gap-12">
            ...
            <div class="lg:col-span-4">
                ...
                <div class="public-footer__badges">
                    @foreach ($footer['trust_badges'] as $badge)
                        <span class="public-footer__badge">{{ $badge }}</span>
                    @endforeach
                </div>
            </div>
            ...
            <div class="lg:col-span-3" itemprop="address" itemscope itemtype="https://schema.org/PostalAddress">
                ...
                <ul class="public-footer__contact">
                    ...
                    <li>
                        ...
                        <a href="{{ $contact['phone_href'] }}" itemprop="telephone">{{ $contact['phone'] }}</a>
                    </li>
                    <li>
                        ...
                        <a href="{{ $contact['email_href'] }}" itemprop="email">{{ $contact['email'] }}</a>
                    </li>
                </ul>
                <p class="mt-4 text-xs text-white/45">{{ $contact['hours'] }} · {{ $contact['hours_weekend'] }}</p>
            </div>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    ...
                    <a href="{{ $contact['phone_href'] }}" class="public-footer__quick-link">
                        Call Us
                    </a>
                </div>
