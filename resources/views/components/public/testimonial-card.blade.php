...
<article {{ $attributes->merge(['class' => 'public-trust-testimonial']) }} data-testimonial-slide>
    ...
    <footer class="public-trust-testimonial__author">
        <cite class="public-trust-testimonial__role">{{ $role }}</cite>
        <span class="public-trust-testimonial__location">{{ $location }}</span>
    </footer>
</article>
