<x-admin-layout :title="__('Create Purchase Order')" :breadcrumbs="[['label' => __('Procurement')], ['label' => __('Purchase Orders'), 'url' => route('admin.procurement.orders.index')], ['label' => __('Create')]]">
