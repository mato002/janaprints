<x-admin-layout :title="__('Edit Vendor')" :breadcrumbs="[['label' => __('Procurement')], ['label' => __('Vendors'), 'url' => route('admin.procurement.vendors.index')], ['label' => $vendor->vendor_name]]">
