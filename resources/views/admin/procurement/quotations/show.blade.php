<x-admin-layout :title="$quotation->quotation_number" :breadcrumbs="[['label' => __('Procurement')], ['label' => __('Supplier Quotations'), 'url' => route('admin.procurement.quotations.index')], ['label' => $quotation->quotation_number]]">
