            ...
            <div class="overflow-hidden rounded-xl border border-erp-border bg-white shadow-sm">
                <div class="border-b border-erp-border bg-slate-50/80 px-4 py-3">
                    ...
                    <dl class="mt-3 grid grid-cols-2 gap-2 text-xs sm:grid-cols-4">
                        <div>
                            <dt class="text-[10px] uppercase tracking-wide text-slate-400">{{ __('Customer') }}</dt>
                        ...
                        <div>
                            <dt class="text-[10px] uppercase tracking-wide text-slate-400">{{ __('Status') }}</dt>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3">
                    <div class="space-y-0 border-b border-erp-border lg:col-span-2 lg:border-b-0 lg:border-r">
                        <section id="designer-desk-files" class="border-b border-erp-border p-4">
                            <h3 class="mb-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">{{ __('Artwork & files') }}</h3>

                            <div class="mb-3">
                                <p class="mb-1 text-[10px] font-semibold uppercase text-slate-400">{{ __('Versions') }}</p>
                                <template x-if="!(panel.files?.versions?.length)">
                                    <p class="text-sm text-slate-500">{{ __('No artwork uploaded yet.') }}</p>
                                </template>
                            ...
                            <template x-if="panel.files?.customer?.length">
                                <div class="mt-3">
                                    <p class="mb-1 text-[10px] font-semibold uppercase text-slate-400">{{ __('Customer files') }}</p>
                                    <ul class="space-y-1">
                        ...
                        <section class="border-b border-erp-border p-4">
                            <h3 class="mb-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">{{ __('Specification') }}</h3>
                        ...
                        <section class="p-4">
                            <h3 class="mb-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">{{ __('Notes & comments') }}</h3>
                    ...
                    <aside class="flex flex-col bg-slate-50/50 p-4">
                        <h3 class="mb-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">{{ __('Actions') }}</h3>
