...
<x-admin.card class="mb-6">
    <form method="GET" action="{{ route('commercial.reports.sales.index') }}" data-turbo-frame="erp-main" class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div>
            <label class="text-[11px] text-slate-500" for="status">{{ __('Order Status') }}</label>
