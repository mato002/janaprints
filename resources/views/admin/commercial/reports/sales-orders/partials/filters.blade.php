...
<x-admin.card :padding="false" class="mb-4">
    <x-admin.index-toolbar :action="route('commercial.reports.sales_orders.index')" :reset-url="route('commercial.reports.sales_orders.index')" turbo-frame="erp-main">
        ...
        <select id="quotation_source" name="quotation_source" class="erp-toolbar-select" aria-label="{{ __('Quotation source') }}">
