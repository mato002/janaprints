...
@else
    <div class="mb-3">
        <h2 class="text-sm font-semibold text-erp-primary">{{ __('Approvals') }}</h2>
        <p class="text-xs text-slate-600">{{ __('Pending quotations, sales orders, and artwork submissions.') }}</p>
    </div>
@endif
