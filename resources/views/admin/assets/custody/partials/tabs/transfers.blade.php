<x-admin.card :padding="false" class="mb-4">
    <x-admin.index-toolbar :action="$hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'transfers']))" :reset-url="$hubUrl . '?tab=transfers'">
...
<x-admin.data-table :search-placeholder="__('Search transfers…')" export-filename="asset-transfers">
    <x-slot name="head">
        <tr>
