<x-admin-layout :title="__('Executive Asset Dashboard')" :breadcrumbs="[['label' => __('Assets'), 'url' => route('admin.workspaces.assets')], ['label' => __('Executive Asset Dashboard')]]">
    <x-admin.page-header :title="__('Executive Asset Dashboard')" :description="__('Company-wide asset intelligence.')" />
