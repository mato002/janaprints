<x-admin-layout :title="__('Asset Analytics Center')" :breadcrumbs="[['label' => __('Assets'), 'url' => route('admin.workspaces.assets')], ['label' => __('Analytics Center')]]">
    <x-admin.page-header :title="__('Asset Analytics Center')" :description="__('Cached asset analytics and trends.')" />
