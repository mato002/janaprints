<x-admin.card :padding="false" class="mb-4">
    <x-admin.index-toolbar :action="$hubUrl . '?' . http_build_query(array_merge(request()->except('page'), ['tab' => 'work-orders']))" :reset-url="$hubUrl . '?tab=work-orders'">
        <input type="hidden" name="tab" value="work-orders">
