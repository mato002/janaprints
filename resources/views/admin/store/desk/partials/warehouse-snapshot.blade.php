    ...
    <x-admin.card class="mb-4">
        ...
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            @foreach ($warehouseSnapshot as $warehouse)
                <a href="{{ $warehouse['url'] }}" class="block rounded-lg border border-erp-border bg-white p-3 transition hover:border-erp-accent/40 hover:bg-slate-50" data-turbo-frame="_top">
