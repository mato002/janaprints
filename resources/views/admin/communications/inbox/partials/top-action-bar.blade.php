<div class="shared-inbox__toolbar">
    ...
    <div class="shared-inbox__toolbar-actions" role="toolbar" aria-label="{{ __('Inbox actions') }}">
        ...
        <a
            href="{{ route('admin.communications.inbox.index', request()->query()) }}"
            class="shared-inbox__icon-btn"
            title="{{ __('Refresh') }}"
        ...
        @can('executive', App\Models\Communications\Inbox\CommunicationConversation::class)
            <a href="{{ route('admin.communications.inbox.executive') }}" class="shared-inbox__toolbar-link" data-turbo-frame="erp-main">{{ __('CEO view') }}</a>
        @endcan
        <a href="{{ route('admin.communications.inbox.team') }}" class="shared-inbox__toolbar-link" data-turbo-frame="erp-main">{{ __('Team') }}</a>
    </div>
</div>
