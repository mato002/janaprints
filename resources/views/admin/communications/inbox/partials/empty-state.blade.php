<section class="shared-inbox__empty">
    ...
    <h2 class="shared-inbox__empty-title">{{ __('Select a conversation') }}</h2>
    <p class="shared-inbox__empty-desc">
        {{ __('Choose a customer thread from the left panel to view messages, files and activity.') }}
    </p>
    <p class="mt-3 flex items-center justify-center gap-1.5 text-xs text-slate-400">
        ...
        {{ __('Or use :new above the list', ['new' => __('New conversation')]) }}
    </p>
</section>
