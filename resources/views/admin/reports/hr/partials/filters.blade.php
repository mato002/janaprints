...
<x-admin.card class="mb-6">
    <form method="GET" action="{{ route('admin.reports.hr') }}" data-turbo-frame="erp-main" class="flex flex-wrap items-end gap-3">
        ...
        <div>
            <label class="text-[11px] text-slate-500" for="job_title_id">{{ __('Job Title') }}</label>
            <select id="job_title_id" name="job_title_id" class="erp-input mt-1 min-w-[10rem]">
