            ...
            <template x-if="panel">
                <div class="space-y-4">
                    <dl class="grid grid-cols-2 gap-3 text-sm">
                        <div><dt class="text-slate-500">{{ __('Customer') }}</dt><dd class="font-medium" x-text="panel.header.customer ?? '—'"></dd></div>
                        <div><dt class="text-slate-500">{{ __('Product') }}</dt><dd class="font-medium" x-text="panel.header.product ?? '—'"></dd></div>
                        <div><dt class="text-slate-500">{{ __('Stage') }}</dt><dd x-text="panel.header.stage ?? '—'"></dd></div>
                        <div><dt class="text-slate-500">{{ __('Required') }}</dt><dd x-text="panel.header.required_date ?? '—'"></dd></div>
                    </dl>
