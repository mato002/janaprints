...
@endphp
<x-admin.collapsible-summary :title="__('Queue summary')">
    <div class="production-floor-board workspace-kpi-strip mb-0 grid grid-cols-2 gap-1.5 sm:grid-cols-3 lg:grid-cols-6">
