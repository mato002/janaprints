...
@section('content')
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;border:1px solid #e8ecf2;border-radius:8px;overflow:hidden;">
        ...
        <tr>
            ...
            <td style="padding:10px 16px;font-size:14px;color:#1a2744;border-top:1px solid #e8ecf2;">{{ $quoteRequest->service_needed }}</td>
        </tr>
        @if ($quoteRequest->quantity)
        <tr>
            <td style="padding:10px 16px;font-size:13px;color:#64748b;border-top:1px solid #e8ecf2;">Quantity</td>
            <td style="padding:10px 16px;font-size:14px;color:#1a2744;border-top:1px solid #e8ecf2;">{{ $quoteRequest->quantity }}</td>
        </tr>
        @endif
        @if ($quoteRequest->deadline)
        <tr>
            <td style="padding:10px 16px;font-size:13px;color:#64748b;border-top:1px solid #e8ecf2;">Deadline</td>
            <td style="padding:10px 16px;font-size:14px;color:#1a2744;border-top:1px solid #e8ecf2;">{{ $quoteRequest->deadline }}</td>
        </tr>
        @endif
        @if ($quoteRequest->company)
        <tr>
            <td style="padding:10px 16px;font-size:13px;color:#64748b;border-top:1px solid #e8ecf2;">Company</td>
            <td style="padding:10px 16px;font-size:14px;color:#1a2744;border-top:1px solid #e8ecf2;">{{ $quoteRequest->company }}</td>
        </tr>
        @endif
