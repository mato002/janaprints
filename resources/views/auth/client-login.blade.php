        ...
        <div class="public-container max-w-md">
            <div class="rounded-brand-xl border border-white/10 bg-white/5 p-8 shadow-brand-lg backdrop-blur-sm">
                <div class="mb-6 text-center">
                    <span class="inline-flex h-12 w-12 items-center justify-center rounded-brand-lg bg-gradient-to-br from-brand-magenta to-brand-orange text-sm font-bold text-white">JP</span>
