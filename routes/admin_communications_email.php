...
use App\Http\Controllers\Admin\Communications\Email\EmailCustomersController;
...
use App\Http\Controllers\Admin\Communications\Email\EmailDraftsController;
...
Route::middleware(['auth', 'verified', 'tenant'])
    ...
    ->group(function () {
        Route::middleware('permission:communications.email.view')->group(function () {
            ...
            Route::get('drafts', [EmailDraftsController::class, 'index'])->name('drafts.index');
            Route::get('customers', [EmailCustomersController::class, 'index'])->name('customers.index');
